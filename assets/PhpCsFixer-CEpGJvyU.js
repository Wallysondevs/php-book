import{j as e}from"./index-B5-q-eol.js";import{P as s,A as i,a as r}from"./AlertBox-CVbFLZEd.js";import{T as o}from"./TerminalBlock-6fqVIX2R.js";import{C as n}from"./CodeBlock-B36pQ_ak.js";function p(){return e.jsxs(s,{title:"PHP-CS-Fixer & PSR-12",subtitle:"Pare de discutir indentação no PR. Configure o PHP-CS-Fixer uma vez e nunca mais perca tempo formatando código manualmente.",difficulty:"intermediario",timeToRead:"12 min",category:"Qualidade",children:[e.jsx(i,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"PHP CS Fixer"})," "," — "," ","corrige estilo automaticamente."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Rule sets"})," "," — "," ","@PSR12, @PhpCsFixer, @Symfony."]}),e.jsxs("li",{children:[e.jsx("strong",{children:".php-cs-fixer.dist.php"})," "," — "," ","config no projeto."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"CI integration"})," "," — "," ","rode em pre-commit + pipeline."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"vs PHP_CodeSniffer"})," "," — "," ","sniffer só aponta; fixer corrige."]})]}),e.jsx("h2",{children:"O problema: o code review virou aula de estilo"}),e.jsxs("p",{children:["Espaço antes do parêntese? Chaves na mesma linha? ",e.jsx("code",{children:"use"})," ordenado por nome? Toda equipe perde semanas discutindo isso. A solução é delegar a regra para uma ferramenta:"," ",e.jsx("strong",{children:"PHP-CS-Fixer"}),". Ele lê seu código, aplica regras (PSR-12, PER-CS, custom) e"," ",e.jsx("em",{children:"reescreve os arquivos"})," automaticamente."]}),e.jsx("h2",{children:"Instalação"}),e.jsx(o,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"composer require --dev friendsofphp/php-cs-fixer",output:`Using version ^3.64 for friendsofphp/php-cs-fixer
...
Generating autoload files`}),e.jsxs("p",{children:["O binário fica em ",e.jsx("code",{children:"vendor/bin/php-cs-fixer"}),". Antes de configurar nada, vamos ver o efeito num arquivo bagunçado:"]}),e.jsx(r,{filename:"src/Pedido.php (antes)",code:`<?php
namespace App;
use App\\Cliente ;
use App\\Item;
use Stringable;
...
Found 1 of 1 files that can be fixed in 0.234 seconds, 12.000 MB memory used`}),e.jsxs("p",{children:["Gostou? Aceite. Tira o ",e.jsx("code",{children:"--dry-run"}),":"]}),e.jsx(o,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"vendor/bin/php-cs-fixer fix",output:`Loaded config default from ".php-cs-fixer.dist.php".
   1) src/Pedido.php
Fixed 1 of 1 files in 0.198 seconds, 12.000 MB memory used`}),e.jsx("p",{children:"O resultado é o mesmo arquivo, agora respeitando todas as regras:"}),e.jsx(r,{filename:"src/Pedido.php (depois)",code:`<?php
