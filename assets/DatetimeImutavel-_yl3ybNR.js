import{j as e}from"./index-Bb4MiiJL.js";import{P as o,a,A as t}from"./AlertBox-BpD-xIsb.js";import{T as i}from"./TerminalBlock-DGurMC1r.js";function m(){return e.jsxs(o,{title:"DateTimeImmutable",subtitle:"A API orientada a objetos para datas no PHP — imutável, type-safe e à prova de bugs sutis. Saia do date()/strtotime() e entre no mundo civilizado.",difficulty:"intermediario",timeToRead:"13 min",category:"Datas & Tempo",children:[e.jsx("h2",{children:"O bug que vai te assombrar com DateTime"}),e.jsxs("p",{children:["PHP tem duas classes equivalentes: ",e.jsx("code",{children:"DateTime"})," (mutável) e"," ",e.jsx("code",{children:"DateTimeImmutable"})," (imutável). Elas têm a mesma API — mas a primeira é uma armadilha ambulante. Veja por quê:"]}),e.jsx(a,{filename:"bug-mutavel.php",code:`<?php
...
Entrega: 24/03/2025 10:00`}),e.jsxs(t,{type:"success",title:"Regra de ouro",children:["Use ",e.jsx("strong",{children:"sempre"})," ",e.jsx("code",{children:"DateTimeImmutable"}),". ",e.jsx("code",{children:"modify()"}),","," ",e.jsx("code",{children:"add()"}),", ",e.jsx("code",{children:"sub()"})," e ",e.jsx("code",{children:"setDate()"})," retornam uma"," ",e.jsx("em",{children:"nova instância"})," em vez de alterar a original. Isso elimina uma classe inteira de bugs."]}),e.jsx("h2",{children:"Criando instâncias"}),e.jsxs("p",{children:["Existem três caminhos principais. O construtor aceita qualquer string que"," ",e.jsx("code",{children:"strtotime()"})," entenda; ",e.jsx("code",{children:"createFromFormat()"})," resolve formatos brasileiros; e ",e.jsx("code",{children:"createFromInterface()"})," converte de um ",e.jsx("code",{children:"DateTime"})," mutável existente."]}),e.jsx(a,{filename:"criando.php",code:`<?php
declare(strict_types=1);
...
bool(true)
bool(false)
bool(true)`}),e.jsxs(t,{type:"info",title:"Por que readonly + DateTimeImmutable são amigos",children:["A propriedade ",e.jsx("code",{children:"readonly"})," do PHP 8.1+ garante que ninguém substitua o objeto. Como"," ",e.jsx("code",{children:"DateTimeImmutable"})," também não pode ser modificada in-place, você ganha invariância completa — perfeito para entidades de domínio (datas de assinatura, vencimentos, agendas)."]}),e.jsx("h2",{children:"Type hints: aceite a interface, não a classe"}),e.jsxs("p",{children:["Quando uma função pode receber qualquer tipo de data, use a interface"," ",e.jsx("code",{children:"DateTimeInterface"}),". Assim aceita tanto ",e.jsx("code",{children:"DateTime"})," quanto"," ",e.jsx("code",{children:"DateTimeImmutable"}),":"]}),e.jsx(a,{filename:"interface.php",code:`<?php
declare(strict_types=1);
