import{j as e}from"./index-Bb4MiiJL.js";import{P as i,a as o,A as s}from"./AlertBox-BpD-xIsb.js";import{T as a}from"./TerminalBlock-DGurMC1r.js";import{C as r}from"./CodeBlock-C3V-qEkN.js";function c(){return e.jsxs(i,{title:"Migrations (Phinx)",subtitle:"Versione o schema do banco como você versiona código: cada mudança é um arquivo PHP com up/down, aplicável e reversível em qualquer ambiente.",difficulty:"intermediario",timeToRead:"13 min",category:"Banco Avançado",children:[e.jsx("h2",{children:"O problema: alguém rodou um ALTER TABLE em produção"}),e.jsxs("p",{children:["Você puxa o último ",e.jsx("code",{children:"git pull"}),", sobe a aplicação e ela quebra: a coluna"," ",e.jsx("code",{children:"users.last_login_at"})," não existe no seu banco local. Quem criou? Quando? Como replicar em staging e em produção sem esquecer nada? ",e.jsx("strong",{children:"Migrations"})," resolvem isso: cada alteração no schema vira um arquivo versionado no Git, com um ",e.jsx("em",{children:"id de timestamp"}),", e o banco mantém uma tabela interna sabendo quais já foram aplicadas."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Phinx"})," é a biblioteca de migrations standalone mais usada do PHP — funciona fora de qualquer framework, suporta MySQL, Postgres e SQLite, e tem uma API fluente clara."]}),e.jsx("h2",{children:"Instalação"}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"composer require --dev robmorgan/phinx",output:`Using version ^0.16.0 for robmorgan/phinx
...
];`}),e.jsx("h2",{children:"Criando sua primeira migration"}),e.jsxs("p",{children:["O comando ",e.jsx("code",{children:"create"})," gera um arquivo com timestamp no nome — isso garante que duas pessoas trabalhando em paralelo não tenham conflito de ordenação."]}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"vendor/bin/phinx create CreateUsersTable",output:`Phinx by CakePHP - https://phinx.org.
...
created db/migrations/20250115120000_create_users_table.php`}),e.jsx(o,{filename:"db/migrations/20250115120000_create_users_table.php",code:`<?php
declare(strict_types=1);
...
}`}),e.jsxs(s,{type:"info",title:"change() vs up()/down()",children:["Use ",e.jsx("code",{children:"change()"})," sempre que possível: o Phinx ",e.jsx("strong",{children:"infere o down automaticamente"})," ","(criou tabela ⇒ rollback dropa). Para operações irreversíveis (UPDATE de dados, ALTER complexo), implemente ",e.jsx("code",{children:"up()"})," e ",e.jsx("code",{children:"down()"})," separadamente."]}),e.jsx("h2",{children:"Aplicando: migrate"}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"vendor/bin/phinx migrate -e development",output:`Phinx by CakePHP - https://phinx.org.
...
All Done. Took 0.0142s`}),e.jsx("h2",{children:"Status: o que foi e o que falta aplicar"}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"vendor/bin/phinx status -e development",output:` Status   Migration ID    Started              Finished             Migration Name
-----------------------------------------------------------------------------------
     up  20250115120000  2025-01-15 12:01:43  2025-01-15 12:01:43  CreateUsersTable

ordering by creation time`}),e.jsx("h2",{children:"Migration mais realista: ALTER + foreign keys"}),e.jsx("p",{children:"Migrations brilham quando o schema evolui. Vamos adicionar uma tabela de pedidos referenciando usuários — note como o Phinx abstrai a sintaxe específica de cada banco."}),e.jsx(o,{filename:"db/migrations/20250116090000_create_pedidos_table.php",code:`<?php
declare(strict_types=1);
...
}`}),e.jsxs(s,{type:"warning",title:"Cuidado com dados em migrations",children:["Backfill de muitas linhas dentro de migration é arriscado em produção: trava a tabela e estoura timeout. Para volumes grandes, faça a migration ",e.jsx("strong",{children:"só do schema"})," (coluna nullable) e rode um ",e.jsx("em",{children:"script de backfill"})," em batch separadamente."]}),e.jsx("h2",{children:"Rollback: voltando uma migration"}),e.jsxs("p",{children:[e.jsx("code",{children:"rollback"})," sem argumento volta apenas a última. Com ",e.jsx("code",{children:"-t 0"})," volta tudo."]}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"vendor/bin/phinx rollback -e development",output:`Phinx by CakePHP - https://phinx.org.
...
All Done. Took 0.0189s`}),e.jsx("h2",{children:"Seeds: dados de exemplo, não dados de produção"}),e.jsx(o,{filename:"db/seeds/UsersSeeder.php",code:`<?php
declare(strict_types=1);
...
}`}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"vendor/bin/phinx seed:run -e development",output:`Phinx by CakePHP - https://phinx.org.
