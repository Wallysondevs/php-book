import{j as e}from"./index-B5-q-eol.js";import{P as d,A as r,a}from"./AlertBox-CVbFLZEd.js";import{T as s}from"./TerminalBlock-6fqVIX2R.js";import{C as o}from"./CodeBlock-B36pQ_ak.js";function p(){return e.jsxs(d,{title:"Autoload PSR-4",subtitle:"Como o Composer transforma uma simples chamada new App\\Models\\User em mágica: ele lê o composer.json, mapeia namespaces para pastas e carrega arquivos sob demanda.",difficulty:"avancado",timeToRead:"11 min",category:"Namespaces & Composer",children:[e.jsx(r,{type:"info",title:"Pré-requisitos",children:e.jsxs("p",{children:["Antes deste capítulo, é bom já ter visto: ",e.jsx("a",{href:"#/namespaces",className:"text-[#8993BE] underline",children:"Namespaces"})," e ",e.jsx("a",{href:"#/composer",className:"text-[#8993BE] underline",children:"Composer"}),"."]})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"spl_autoload_register"})," "," — "," ","registra função chamada quando classe não encontrada."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"PSR-4"})," "," — "," ","padrão moderno: namespace = pasta, classe = arquivo."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Composer autoload"})," "," — "," ","composer dump-autoload regenera o vendor/autoload.php."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Optimized"})," "," — "," ","composer dump-autoload -o pré-computa o mapa."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Classmap"})," "," — "," ","lista explícita de arquivo→classe; útil em deploy."]})]}),e.jsxs("p",{children:[e.jsx("strong",{className:"text-[#8993BE] font-mono",children:"autoload PSR-4"})," — padrão da comunidade que mapeia ",e.jsx("em",{children:"prefixo de namespace"})," para ",e.jsx("em",{children:"pasta no disco"}),". Existe pra você nunca mais escrever ",e.jsx("code",{children:"require"})," manual: ",e.jsx("code",{children:"App\\Models\\User"})," vira ",e.jsx("code",{children:"src/Models/User.php"})," automaticamente. Configurado na chave ",e.jsx("code",{children:"autoload.psr-4"})," do ",e.jsx("code",{children:"composer.json"}),"."]}),e.jsx("h2",{children:"O mundo sem autoload (e por que ele dói)"}),e.jsx("p",{children:"Antes do PSR-4, qualquer arquivo PHP precisava listar manualmente todas as classes que usava. Imagine 200 classes em 30 arquivos:"}),e.jsx(a,{filename:"velho-mundo.php",code:`<?php
