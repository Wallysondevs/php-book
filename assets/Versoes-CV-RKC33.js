import{j as e}from"./index-Bb4MiiJL.js";import{P as a,A as i,a as s}from"./AlertBox-BpD-xIsb.js";import{T as o}from"./TerminalBlock-DGurMC1r.js";import{C as r}from"./CodeBlock-C3V-qEkN.js";function l(){return e.jsxs(a,{title:"Versões e Roadmap",subtitle:"PHP 7.x vs 8.x, novidades de 8.0 a 8.4, datas de fim de suporte (EOL) e como gerenciar várias versões na mesma máquina com phpenv ou asdf.",difficulty:"iniciante",timeToRead:"9 min",category:"Introdução",children:[e.jsx("h2",{children:"Qual versão você deve usar agora"}),e.jsxs("p",{children:["Se você está começando um projeto hoje, a resposta é simples: ",e.jsx("strong",{children:"PHP 8.4"}),". Se a sua empresa ainda está em 8.1 ou 8.2, está tudo bem — são versões maduras. Se está em 7.x, você tem um problema de segurança: a série 7 está totalmente ",e.jsx("em",{children:"fora de suporte"})," desde o final de 2022."]}),e.jsx(i,{type:"danger",title:"Versões fora de suporte são risco de segurança",children:"Sem patches de segurança, qualquer CVE descoberta no interpretador fica aberta para sempre. Plataformas como WordPress, Laravel e Symfony já recusam rodar em PHP < 8.1."}),e.jsx("h2",{children:"O calendário oficial (resumido)"}),e.jsxs("p",{children:["O time do PHP segue um ciclo previsível: ",e.jsx("strong",{children:"2 anos de bugfix + 1 ano só de segurança"}),". Depois disso, a versão é EOL (End-Of-Life)."]}),e.jsx(r,{title:"suporte.txt",language:"text",code:`Versão   Lançamento   Bugfix até   Segurança até   Status
...
echo $p->imposto();`,output:"160"}),e.jsx(s,{filename:"produto_php84.php",code:`<?php
...
// $c->saldo = 9999.99; // Erro: cannot modify private(set) property`,output:"Saldo: R$ 100,50"}),e.jsxs(i,{type:"success",title:"Para projetos novos em 2026",children:["Comece em ",e.jsx("strong",{children:"PHP 8.4"}),". Você tem suporte até 2028, todas as features modernas, e compatibilidade com qualquer framework atual (Laravel 11+, Symfony 7+, WordPress 6.4+)."]}),e.jsx("h2",{children:"Gerenciando múltiplas versões"}),e.jsx("p",{children:"Cedo ou tarde você vai trabalhar em dois projetos: um em PHP 8.1 (legado) e outro em 8.4 (novo). Não tente instalar duas versões manualmente — use um gerenciador."}),e.jsx("h3",{children:"Opção 1: asdf (recomendado, multi-linguagem)"}),e.jsx(o,{user:"dev",host:"php",cwd:"~",command:"asdf plugin add php https://github.com/asdf-community/asdf-php.git",output:`initializing plugin repository...
plugin "php" added`}),e.jsx(o,{user:"dev",host:"php",cwd:"~",command:"asdf install php 8.4.1 && asdf install php 8.1.31",output:`Downloading php-8.4.1...
Compiling php-8.4.1... done
Downloading php-8.1.31...
Compiling php-8.1.31... done`}),e.jsxs("p",{children:["Agora dentro de cada projeto você fixa a versão criando um ",e.jsx("code",{children:".tool-versions"}),":"]}),e.jsx(r,{title:".tool-versions",language:"text",code:"php 8.4.1"}),e.jsx(o,{user:"dev",host:"php",cwd:"~/projeto-novo",command:"php -v",output:`PHP 8.4.1 (cli) (built: Nov 19 2024 18:02:10) (NTS)
Copyright (c) The PHP Group
Zend Engine v4.4.1, Copyright (c) Zend Technologies`}),e.jsx("h3",{children:"Opção 2: phpenv (só PHP, estilo rbenv)"}),e.jsx(o,{user:"dev",host:"php",cwd:"~",command:"phpenv install 8.4.1 && phpenv global 8.4.1",output:`[Info]: Loaded php-build version ...
[Success]: Built 8.4.1 successfully.`}),e.jsx("h3",{children:"Opção 3 (Linux): pacotes do sistema com sufixo"}),e.jsxs("p",{children:["No Ubuntu/Debian o repositório ",e.jsx("em",{children:"ondrej/php"})," permite ter ",e.jsx("code",{children:"php8.1"}),", ",e.jsx("code",{children:"php8.3"})," ","e ",e.jsx("code",{children:"php8.4"})," instalados lado a lado:"]}),e.jsx(o,{user:"dev",host:"ubuntu",cwd:"~",command:"sudo update-alternatives --config php",output:`There are 3 choices for the alternative php (providing /usr/bin/php).
...
pdo_mysql
pdo_pgsql
Phar`}),e.jsxs("p",{children:["No próximo capítulo a gente ",e.jsx("strong",{children:"instala o PHP do zero"})," em Linux, macOS e Windows (com plano B usando Docker, sempre que der tilt)."]})]})}export{l as default};
