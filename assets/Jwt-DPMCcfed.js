import{j as e}from"./index-B5-q-eol.js";import{P as i,A as s,a as o}from"./AlertBox-CVbFLZEd.js";import{T as a}from"./TerminalBlock-6fqVIX2R.js";import{C as r}from"./CodeBlock-B36pQ_ak.js";function p(){return e.jsxs(i,{title:"JWT — JSON Web Tokens",subtitle:"Como assinar e verificar tokens JWT em PHP com firebase/php-jwt — claims, HS256, RS256 com chaves assimétricas, refresh tokens e o que NUNCA colocar dentro do payload.",difficulty:"avancado",timeToRead:"13 min",category:"Segurança",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"JWT"})," "," — "," ","JSON Web Token — header.payload.signature em base64url."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"HS256 vs RS256"})," "," — "," ","simétrico (segredo) vs assimétrico (par de chaves)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Claims"})," "," — "," ","iss, sub, exp, iat — campos padronizados do payload."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Stateless"})," "," — "," ","servidor não guarda sessão; tudo está no token."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Refresh token"})," "," — "," ","token longo para renovar o access token curto."]})]}),e.jsx("h2",{children:"O que é JWT (e o que ele NÃO é)"}),e.jsxs("p",{children:["Um JSON Web Token é uma string compacta dividida em três partes separadas por ponto: ",e.jsx("code",{children:"header.payload.signature"}),". Header e payload são JSON codificado em base64url; a assinatura prova que o conteúdo não foi alterado por quem não tem a chave."]}),e.jsxs("p",{children:["JWT serve para ",e.jsx("strong",{children:"autenticação stateless"}),": o servidor emite o token no login, o cliente envia em todo request, o servidor valida a assinatura sem consultar banco. Funciona muito bem entre microsserviços e em APIs públicas."]}),e.jsxs(s,{type:"danger",title:"JWT NÃO é criptografia",children:["O payload é apenas ",e.jsx("strong",{children:"base64"})," — qualquer um lê com"," ",e.jsx("code",{children:"jwt.io"}),". A assinatura impede ",e.jsx("em",{children:"alteração"}),", não"," ",e.jsx("em",{children:"leitura"}),". Nunca coloque senha, CPF, cartão ou qualquer dado sensível dentro de um JWT. Para criptografar, você precisa de JWE — não coberto aqui porque raramente vale a pena em vez de TLS + sessão."]}),e.jsx("h2",{children:"Instalação"}),e.jsxs("p",{children:["A biblioteca padrão de fato é ",e.jsx("code",{children:"firebase/php-jwt"})," — auditada, zero dependências, suporta HS256/HS384/HS512, RS256, ES256 e EdDSA."]}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/api",command:"composer require firebase/php-jwt",output:`Using version ^6.10 for firebase/php-jwt
...
}`}),e.jsx("h2",{children:"RS256: chaves assimétricas para múltiplos serviços"}),e.jsxs("p",{children:["Em arquiteturas com vários microsserviços, você quer que ",e.jsx("em",{children:"só o auth-service"})," ","possa emitir tokens, mas ",e.jsx("em",{children:"todos"})," possam verificar. RS256 resolve: chave privada assina (fica só no emissor), chave pública verifica (distribuída para todos). Comprometer uma instância consumidora não permite forjar tokens."]}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/api/keys",command:"openssl genrsa -out private.pem 2048 && openssl rsa -in private.pem -pubout -out public.pem",output:`Generating RSA private key, 2048 bit long modulus (2 primes)
.............+++++
.....................+++++
e is 65537 (0x010001)
writing RSA key
...
echo "Sub: {$payload->sub}, expira em: " . date('H:i:s', $payload->exp);`,output:"Sub: 42, expira em: 14:35:00"}),e.jsxs(s,{type:"info",title:"Rotação de chaves com kid",children:["O ",e.jsx("code",{children:"kid"})," (key id) no header do JWT permite trocar a chave sem invalidar tokens em circulação: o verificador olha o ",e.jsx("code",{children:"kid"})," e escolhe a chave certa de um array. Padrão usado por Auth0, Cognito, Keycloak."]}),e.jsx(o,{filename:"kid-rotacao.php",code:`<?php
declare(strict_types=1);
