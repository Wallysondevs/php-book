import{j as e}from"./index-B5-q-eol.js";import{P as s,A as a,a as o}from"./AlertBox-CVbFLZEd.js";import{T as r}from"./TerminalBlock-6fqVIX2R.js";import{C as i}from"./CodeBlock-B36pQ_ak.js";function l(){return e.jsxs(s,{title:"Transações & Locking",subtitle:"Quando duas operações precisam acontecer juntas (ou nenhuma), bem-vindo às transações. E quando duas conexões disputam a mesma linha, bem-vindo aos locks, savepoints e deadlocks.",difficulty:"avancado",timeToRead:"14 min",category:"Banco Avançado",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"beginTransaction()"})," "," — "," ","inicia bloco transacional."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"commit() / rollBack()"})," "," — "," ","confirma ou desfaz tudo."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"ACID"})," "," — "," ","atomicidade, consistência, isolamento, durabilidade."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Savepoints"})," "," — "," ","marcadores intermediários para rollback parcial."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Isolation level"})," "," — "," ","READ COMMITTED, REPEATABLE READ etc — controla concorrência."]})]}),e.jsx("h2",{children:"O problema clássico: a transferência bancária"}),e.jsxs("p",{children:["Você precisa ",e.jsx("strong",{children:"debitar R$ 100 da conta A"})," e ",e.jsx("strong",{children:"creditar R$ 100 na conta B"}),". Se o servidor cair entre as duas queries, a conta A ficou com R$ 100 a menos e a conta B nunca recebeu — você criou dinheiro do nada (ou destruiu, dependendo da ordem). A solução é tratar as duas operações como ",e.jsx("em",{children:"uma só"}),": ou as duas funcionam, ou nenhuma. Isso é uma ",e.jsx("strong",{children:"transação"}),"."]}),e.jsx("h2",{children:"O padrão sagrado: try / commit / catch / rollBack"}),e.jsx(o,{filename:"src/Transferencia.php",code:`<?php
...
}`}),e.jsx(o,{filename:"bin/transferir.php",code:`<?php
declare(strict_types=1);
...
Cliente 42 salvo (sem cep).`}),e.jsx("h2",{children:"Resumo prático: SQL gerado"}),e.jsx(i,{title:"o que o PDO realmente envia",language:"bash",code:`-- PDO::beginTransaction()
START TRANSACTION;
