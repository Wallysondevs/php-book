...
}`}),e.jsx("p",{children:"Pronto: você tem logging padronizado, plugável, com retenção de disco resolvida, integrado ao journald e pronto pra subir pro stack de observabilidade. PSR-3 é a base do PHP moderno — toda lib séria já entrega o suporte."})]})}export{c as default};
