import{j as e}from"./index-Bb4MiiJL.js";import{P as r,A as o,a}from"./AlertBox-BpD-xIsb.js";function n(){return e.jsxs(r,{title:"Arrow functions e Closures",subtitle:"Funções anônimas em PHP: a sintaxe curta fn() => para uma linha, closures clássicas com use(), referências mutáveis e o truque do bindTo.",difficulty:"intermediario",timeToRead:"11 min",category:"Funções",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:e.jsxs("p",{children:["Antes deste capítulo, é bom já ter visto: ",e.jsx("a",{href:"#/funcoes",className:"text-[#8993BE] underline",children:"Funções básicas"}),", ",e.jsx("a",{href:"#/type-hints",className:"text-[#8993BE] underline",children:"Type hints"}),", ",e.jsx("a",{href:"#/array-functions",className:"text-[#8993BE] underline",children:"Array functions"}),"."]})}),e.jsx("h2",{children:"O problema: passar comportamento como argumento"}),e.jsxs("p",{children:["Funções como ",e.jsx("code",{children:"array_map"}),", ",e.jsx("code",{children:"array_filter"})," e ",e.jsx("code",{children:"usort"})," esperam que você diga ",e.jsx("em",{children:"como"})," transformar/filtrar/comparar os elementos. Declarar uma função nomeada só para usar uma vez é desperdício de neurônio. Para isso existem as"," ",e.jsx("strong",{children:"funções anônimas"})," — closures e arrow functions."]}),e.jsx(a,{filename:"map-clas.php",code:`<?php
...
(
    ...
    [3] => 8
    [5] => 12
)`}),e.jsxs(o,{type:"info",title:"Quando NÃO usar arrow function",children:["Arrow functions são limitadas a ",e.jsx("strong",{children:"uma única expressão"}),". Se precisa de",e.jsx("code",{children:"if"}),", várias linhas ou um log no meio, volte para a closure clássica com"," ",e.jsxs("code",{children:["function() ","{...}"]}),"."]}),e.jsx("h2",{children:"Closure clássica e a palavra-chave use"}),e.jsxs("p",{children:["A closure tradicional (",e.jsxs("code",{children:["function () ","{...}"]}),") ",e.jsx("strong",{children:"não captura automaticamente"})," variáveis do escopo externo. Você precisa listá-las explicitamente com ",e.jsx("code",{children:"use ($var)"}),". Por padrão a captura é ",e.jsx("em",{children:"por valor"})," — uma cópia no momento em que a closure é criada."]}),e.jsx(a,{filename:"closure-use.php",code:`<?php
declare(strict_types=1);
...
soma = 100`}),e.jsxs(o,{type:"warning",title:"Arrow function não tem use",children:["Lembre-se: ",e.jsx("code",{children:"fn()"})," captura tudo automaticamente, mas ",e.jsx("strong",{children:"sempre por valor"}),". Se você precisa modificar uma variável externa, use closure clássica com"," ",e.jsx("code",{children:"use (&$var)"}),"."]}),e.jsx("h2",{children:"bindTo: closures que viram métodos de objeto"}),e.jsxs("p",{children:["Toda closure em PHP é um objeto da classe ",e.jsx("code",{children:"Closure"}),". O método"," ",e.jsx("code",{children:"bindTo($obj, $escopo)"})," devolve uma nova closure que enxerga"," ",e.jsx("code",{children:"$this"})," como se fosse um método do objeto passado. Útil para estender objetos sem subclassificar, ou para hooks dinâmicos."]}),e.jsx(a,{filename:"bindto.php",code:`<?php
declare(strict_types=1);
...
echo "saldo final: " . $conta->saldo();`,output:"saldo final: 75.5"}),e.jsxs(o,{type:"info",title:"bindTo vs Closure::bind",children:[e.jsx("code",{children:"$closure->bindTo($obj, $escopo)"})," é o método de instância;"," ",e.jsx("code",{children:"Closure::bind($closure, $obj, $escopo)"})," é o estático equivalente. O segundo parâmetro é a classe cujo escopo (privado/protegido) a closure terá acesso."]}),e.jsx("h2",{children:"Caso real: pipeline de transformações"}),e.jsxs("p",{children:["Combine arrow functions com ",e.jsx("code",{children:"array_map"}),", ",e.jsx("code",{children:"array_filter"})," e"," ",e.jsx("code",{children:"array_reduce"})," para escrever pipelines declarativos — o jeito moderno de tratar listas em PHP."]}),e.jsx(a,{filename:"pipeline.php",code:`<?php
declare(strict_types=1);
