import{j as e}from"./index-B5-q-eol.js";import{P as t,A as s,a as o}from"./AlertBox-CVbFLZEd.js";import{T as r}from"./TerminalBlock-6fqVIX2R.js";function c(){return e.jsxs(t,{title:"Attributes (PHP 8.0)",subtitle:"Metadados estruturados anexados a classes, métodos e propriedades — a base moderna de routing, validação, ORMs e DI no Symfony, Laravel e Doctrine.",difficulty:"avancado",timeToRead:"12 min",category:"PHP Moderno",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"#[Attribute]"})," "," — "," ","metadados estruturados em classes/métodos/props."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Compile-time"})," "," — "," ","parsed mas não executados sem reflection."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"vs annotations"})," "," — "," ","sintaxe nativa, sem doc-comment hack."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Uso comum"})," "," — "," ","rotas, validação, ORM mapping (Doctrine, Symfony)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Targets"})," "," — "," ","#[Attribute(Attribute::TARGET_METHOD)] limita onde se aplica."]})]}),e.jsx("h2",{children:"O problema: docblocks como código disfarçado de comentário"}),e.jsx("p",{children:"Antes do PHP 8, frameworks como Symfony e Doctrine guardavam metadados em comentários DocBlock. Funciona, mas é frágil: o IDE não checa, um typo passa batido, e ferramentas tinham que parsear strings para entender a sua intenção."}),e.jsx(o,{filename:"legado.php",code:`<?php
...
email      VARCHAR(255) NOT NULL`}),e.jsx("h2",{children:"Comparação rápida: DocBlock vs Attribute"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Validação"}),": DocBlock falha em runtime com mensagem confusa; attribute falha na hora com erro do PHP."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"IDE/refactor"}),": attribute é classe — autocomplete, rename, find-usages funcionam. DocBlock é string opaca."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Performance"}),": Reflection nativa é mais rápida que parsear docblock com regex toda execução."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Distribuição"}),": attributes funcionam em qualquer projeto PHP 8+ sem dependência extra."]})]}),e.jsxs(s,{type:"warning",title:"Pegadinha clássica",children:["O parser do PHP enxerga ",e.jsx("code",{children:"#[Attr]"})," como attribute, mas em PHP 7 seria interpretado como comentário (",e.jsx("code",{children:"#"})," = comment). Se o seu código precisa rodar em ambos, mantenha attributes em arquivos que ",e.jsx("em",{children:"só"})," ","são carregados em PHP 8+ — ou simplesmente exija PHP 8.4 no"," ",e.jsx("code",{children:"composer.json"}),"."]}),e.jsx("h2",{children:"Verificando suporte e rodando"}),e.jsx(r,{user:"dev",host:"php",cwd:"~/projetos/attrs",command:"php -v",output:`PHP 8.4.1 (cli)
Copyright (c) The PHP Group
Zend Engine v4.4.1`}),e.jsx(r,{user:"dev",host:"php",cwd:"~/projetos/attrs",command:"php router.php",output:`GET  /usuarios/{id}          -> UserController::show()
