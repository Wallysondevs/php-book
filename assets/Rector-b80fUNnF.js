...
[OK] 1 file would have been changed`}),e.jsx("h2",{children:"Custom rector: regras do seu domínio"}),e.jsxs("p",{children:["Você pode escrever ",e.jsx("em",{children:"rectors"})," próprios para padrões internos da equipe. Exemplo: renomear um método legado em todas as chamadas:"]}),e.jsx(t,{language:"bash",code:`vendor/bin/rector custom-rule
