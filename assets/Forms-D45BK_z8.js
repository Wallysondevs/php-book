import{j as e}from"./index-Bb4MiiJL.js";import{P as a,a as s,A as o}from"./AlertBox-BpD-xIsb.js";import{T as i}from"./TerminalBlock-DGurMC1r.js";import{B as r}from"./BrowserBlock-C5ENTT0j.js";function n(){return e.jsxs(a,{title:"Formulários ($_GET, $_POST)",subtitle:"A web é feita de formulários: do search até o checkout. Aqui você aprende a receber dados de forma segura, validar com filter_input e blindar contra XSS.",difficulty:"intermediario",timeToRead:"13 min",category:"Web & Banco",children:[e.jsx("h2",{children:"O básico: um formulário e quem o recebe"}),e.jsxs("p",{children:["O navegador envia dados via dois métodos principais: ",e.jsx("strong",{children:"GET"})," (na URL) e"," ",e.jsx("strong",{children:"POST"})," (no corpo da requisição). PHP expõe esses dados nos super-globais ",e.jsx("code",{children:"$_GET"})," e ",e.jsx("code",{children:"$_POST"}),"."]}),e.jsx(s,{filename:"public/contato.php",code:`<?php
