...
(
    ...
    [port] => 5432
    [user] => guest
)`}),e.jsxs(o,{type:"success",title:"?? vs ?:",children:[e.jsx("code",{children:"??"})," só dispara quando o valor é ",e.jsx("strong",{children:"null ou não existe"}),".",e.jsx("code",{children:" ?:"})," dispara em qualquer valor ",e.jsx("strong",{children:"falsy"})," (incluindo ",e.jsx("code",{children:"0"})," e ",e.jsx("code",{children:'""'}),"). Quase sempre você quer ",e.jsx("code",{children:"??"})," — ele evita a pegadinha do ",e.jsx("code",{children:"0"})," ser tratado como ausência de valor."]}),e.jsx("h2",{children:"Combinando tudo: validação real"}),e.jsx(a,{filename:"validacao.php",code:`<?php
declare(strict_types=1);
