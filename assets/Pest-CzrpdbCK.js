import{j as e}from"./index-B5-q-eol.js";import{P as a,A as t,a as s}from"./AlertBox-CVbFLZEd.js";import{T as o}from"./TerminalBlock-6fqVIX2R.js";import{C as i}from"./CodeBlock-B36pQ_ak.js";function l(){return e.jsxs(a,{title:"Pest — testes elegantes",subtitle:"A mesma engine do PHPUnit, com a sintaxe do Jest. Menos boilerplate, mais expressividade, e um output que dá gosto de olhar.",difficulty:"intermediario",timeToRead:"12 min",category:"Testes",children:[e.jsx(t,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Pest"})," "," — "," ","DSL elegante em cima do PHPUnit."]}),e.jsxs("li",{children:[e.jsx("strong",{children:'it("...", fn() => ...)'})," "," — "," ","sintaxe expressiva inspirada no Jest."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"expect()"})," "," — "," ","API fluente: expect($x)->toBe(1)->toBeInt()."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Higher Order"})," "," — "," ","encadeia testes sem bloco: it()->expect()->toBe()."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Plugins"})," "," — "," ","pest-faker, pest-laravel, parallel, mutation."]})]}),e.jsx("h2",{children:"O problema: PHPUnit é verboso"}),e.jsxs("p",{children:["Em PHPUnit, escrever um teste simples exige uma classe, um namespace, um ",e.jsx("code",{children:"extends TestCase"}),", um método com prefixo ",e.jsx("code",{children:"test_"})," e um ",e.jsx("code",{children:"$this->"}),". Para algo que conceitualmente é só ",e.jsx("em",{children:"“dado X, espero Y”"}),", é bastante cerimônia."]}),e.jsx("p",{children:"O Pest comprime tudo isso em uma linha:"}),e.jsx(s,{filename:"tests/SomaTest.php (PHPUnit)",code:`<?php
...
});`}),e.jsx("p",{children:"Mesma coisa em 3 linhas úteis em vez de 13. Por baixo dos panos, o Pest ainda gera classes e roda em cima do PHPUnit — você ganha sintaxe sem perder o ecossistema."}),e.jsx("h2",{children:"Instalando"}),e.jsx(o,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"composer require --dev pestphp/pest --with-all-dependencies",output:`Using version ^3.5 for pestphp/pest
...
Generating optimized autoload files`}),e.jsx(o,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"./vendor/bin/pest --init",output:`   INFO  Initializing Pest...
...
it('multiplica e ainda retorna inteiro', function (): void {
  ...
  Duration: 0.04s`}),e.jsxs(t,{type:"success",title:"Output que importa",children:["O Pest mostra a descrição em texto natural (",e.jsx("em",{children:"“soma dois inteiros”"}),") em vez de"," ",e.jsx("code",{children:"test_soma_dois_inteiros"}),". Quando alguém quebra o teste, a mensagem fica imediatamente legível para quem nunca leu o código."]}),e.jsx("h2",{children:"A API expect() em cadeia"}),e.jsxs("p",{children:["O ",e.jsx("code",{children:"expect($valor)"})," retorna um objeto que aceita ",e.jsx("strong",{children:"dezenas"})," de verificações encadeáveis. Você descreve um valor por todos os ângulos em uma frase só:"]}),e.jsx(s,{filename:"tests/Unit/ExpectTest.php",code:`<?php
...
@dataProvider                          ->with([...])
setUp() / tearDown()                   beforeEach() / afterEach()`}),e.jsxs(t,{type:"info",title:"Você não precisa migrar tudo",children:["Pest e PHPUnit ",e.jsx("strong",{children:"convivem no mesmo projeto"}),". O comando ",e.jsx("code",{children:"./vendor/bin/pest"}),"roda os dois. Você pode começar a escrever ",e.jsx("em",{children:"novos"})," testes em Pest e deixar os antigos como estão — sem big bang."]}),e.jsx("h2",{children:"Rodando"}),e.jsx(o,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"./vendor/bin/pest --parallel --coverage",output:`   PASS  Tests\\Unit\\CalculadoraTest
