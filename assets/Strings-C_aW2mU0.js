import{j as e}from"./index-B5-q-eol.js";import{P as r,A as o,a as s}from"./AlertBox-CVbFLZEd.js";import{T as a}from"./TerminalBlock-6fqVIX2R.js";function c(){return e.jsxs(r,{title:"Strings",subtitle:"Aspas simples vs duplas, heredoc, nowdoc, sprintf, funções str_*, suporte a multibyte com mb_*, e os helpers modernos do PHP 8: str_contains, str_starts_with e str_ends_with.",difficulty:"iniciante",timeToRead:"12 min",category:"Strings & Arrays",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:e.jsxs("p",{children:["Antes deste capítulo, é bom já ter visto: ",e.jsx("a",{href:"#/variaveis",className:"text-[#8993BE] underline",children:"Variáveis"}),", ",e.jsx("a",{href:"#/tipos",className:"text-[#8993BE] underline",children:"Tipos"}),"."]})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:'"" vs aspas simples'})," "," — "," ","aspas duplas interpolam variáveis e escapes; simples não."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Heredoc"})," "," — "," ","<<<EOT — multiline com interpolação; nowdoc é literal."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"sprintf"})," "," — "," ","formatação tipo printf; %d, %s, %.2f."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"mb_*"})," "," — "," ","versões multibyte para Unicode (mb_strlen, mb_substr)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Concatenação"})," "," — "," ","usa . — não +."]})]}),e.jsx("h2",{children:"Por que existem dois tipos de aspas?"}),e.jsxs("p",{children:["Você abre seu primeiro arquivo PHP e logo encontra ",e.jsx("code",{children:"'texto'"})," e ",e.jsx("code",{children:'"texto"'})," sendo usados sem critério aparente. Não é estilo: a diferença é semântica e tem impacto direto em performance e segurança.",e.jsx("strong",{children:" Aspas duplas interpolam variáveis e processam escapes. Aspas simples são literais."})]}),e.jsxs("p",{children:[e.jsx("strong",{className:"text-[#8993BE] font-mono",children:`'' vs ""`})," — aspas simples são literais (mais rápidas, nada é interpretado). Aspas duplas interpolam ",e.jsx("code",{children:"$variaveis"})," e processam escapes como ",e.jsx("code",{children:"\\n"}),", ",e.jsx("code",{children:"\\t"}),". Sintaxe: ",e.jsx("code",{children:"'literal'"})," ou ",e.jsx("code",{children:'"olá $nome"'}),". A regra prática: simples por padrão, duplas só quando precisar interpolar."]}),e.jsx(s,{filename:"aspas.php",code:`<?php
