...
bool(false)
bool(false)
bool(true)`}),e.jsxs(s,{type:"danger",title:"Regra de ouro",children:[e.jsxs("strong",{children:["Use sempre ",e.jsx("code",{children:"==="})," e ",e.jsx("code",{children:"!=="})]}),". O ",e.jsx("code",{children:"=="})," deveria ter sido removido da linguagem. A única exceção razoável é quando você ",e.jsx("em",{children:"precisa"}),"comparar valores vindos de input (sempre string) com inteiros — e mesmo aí, prefira converter explicitamente antes de comparar."]}),e.jsxs("p",{children:["Os ordenadores (",e.jsx("code",{children:"<"}),", ",e.jsx("code",{children:">"}),", ",e.jsx("code",{children:"<="}),","," ",e.jsx("code",{children:">="}),") não têm versão estrita — comparam normalmente. E PHP 7+ trouxe o"," ","operador ",e.jsx("em",{children:"spaceship"})," ",e.jsx("code",{children:"<=>"}),", que devolve ",e.jsx("code",{children:"-1"}),","," ",e.jsx("code",{children:"0"})," ou ",e.jsx("code",{children:"1"}),":"]}),e.jsxs("p",{children:[e.jsx("strong",{className:"text-[#8993BE] font-mono",children:"fn() =>"})," — arrow function (PHP 7.4+): forma curta de função anônima de uma expressão só. ",e.jsx("code",{children:"fn($a, $b) => $a + $b"})," equivale a uma ",e.jsx("code",{children:"function"})," com ",e.jsx("code",{children:"return"}),". Captura variáveis do escopo automaticamente. Detalhada no capítulo de Funções."]}),e.jsx(o,{filename:"spaceship.php",code:`<?php
declare(strict_types=1);
...
bool(false)
bool(true)
padrão / padrão`}),e.jsxs(s,{type:"warning",title:"Esqueça o and/or",children:["Use ",e.jsx("strong",{children:"sempre"})," ",e.jsx("code",{children:"&&"})," e ",e.jsx("code",{children:"||"}),". As versões em palavras existem por compatibilidade histórica e causam bugs sutis exatamente como o exemplo acima. Não há benefício em usá-las."]}),e.jsx("h2",{children:"Concatenação de string: o ponto solitário"}),e.jsxs("p",{children:["Diferente de quase todas as linguagens modernas, PHP usa ",e.jsx("code",{children:"."})," (ponto) para concatenar strings. Para somar com atribuição combinada, use ",e.jsx("code",{children:".="}),". Em strings com aspas duplas, prefira interpolação direta."]}),e.jsx(o,{filename:"strings.php",code:`<?php
declare(strict_types=1);
