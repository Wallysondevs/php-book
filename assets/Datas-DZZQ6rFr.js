import{j as e}from"./index-B5-q-eol.js";import{P as s,A as a,a as o}from"./AlertBox-CVbFLZEd.js";import{T as r}from"./TerminalBlock-6fqVIX2R.js";import{C as i}from"./CodeBlock-B36pQ_ak.js";function c(){return e.jsxs(s,{title:"Datas e horários",subtitle:"Como o PHP enxerga o tempo: timestamps Unix, date(), strtotime, formatação BR vs ISO 8601 e as armadilhas clássicas de fuso horário.",difficulty:"iniciante",timeToRead:"11 min",category:"Datas & Tempo",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"DateTime"})," "," — "," ","classe principal; mutável."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"DateTimeImmutable"})," "," — "," ","preferida — modify retorna nova."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"DateInterval"})," "," — "," ","duração; P1Y2M3D = 1 ano 2 meses 3 dias."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"DateTimeZone"})," "," — "," ","timezone explícito evita bug de DST."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"format()"})," "," — "," ","Y-m-d H:i:s — letras seguem strftime expandido."]})]}),e.jsx("h2",{children:'O problema: imprimir "agora" em formato brasileiro'}),e.jsxs("p",{children:["Toda aplicação web precisa, mais cedo ou mais tarde, mostrar a data atual. O cliente quer ver"," ",e.jsx("code",{children:"21/03/2025 às 14h30"}),", não ",e.jsx("code",{children:"1742565000"}),". Vamos do zero: o PHP guarda tempo como um inteiro chamado ",e.jsx("strong",{children:"timestamp Unix"})," — segundos desde 1º de janeiro de 1970."]}),e.jsx(o,{filename:"agora.php",code:`<?php
...
21/03/2025 14:30:00 -0300`}),e.jsx("h2",{children:"checkdate: validando antes de processar"}),e.jsx("p",{children:"Recebeu três campos do formulário? Antes de gritar com o usuário, valide:"}),e.jsx(o,{filename:"validar.php",code:`<?php
declare(strict_types=1);
