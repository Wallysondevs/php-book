import{j as e}from"./index-B5-q-eol.js";import{P as a,A as s,a as o}from"./AlertBox-CVbFLZEd.js";import{T as r}from"./TerminalBlock-6fqVIX2R.js";function c(){return e.jsxs(a,{title:"Classes e Objetos",subtitle:"Saia dos arrays associativos e entre na orientação a objetos: defina classes, instancie objetos com new, modele estado com propriedades e comportamento com métodos — tudo no estilo PHP 8.4.",difficulty:"intermediario",timeToRead:"14 min",category:"POO",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:e.jsxs("p",{children:["Antes deste capítulo, é bom já ter visto: ",e.jsx("a",{href:"#/sintaxe",className:"text-[#8993BE] underline",children:"Sintaxe básica"}),", ",e.jsx("a",{href:"#/variaveis",className:"text-[#8993BE] underline",children:"Variáveis"}),", ",e.jsx("a",{href:"#/arrays",className:"text-[#8993BE] underline",children:"Arrays"})," e ",e.jsx("a",{href:"#/funcoes",className:"text-[#8993BE] underline",children:"Funções"}),"."]})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"class Nome"})," "," — "," ","declaração de classe; convenção PascalCase."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"$this"})," "," — "," ","referência ao objeto atual dentro de métodos de instância."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"new Nome()"})," "," — "," ","instancia a classe, chamando __construct."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Propriedades"})," "," — "," ","public/private/protected $x — variáveis da instância."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"self vs $this"})," "," — "," ","self::CONST acessa estático/constante; $this->x é instância."]})]}),e.jsx("h2",{children:"O problema: arrays associativos não escalam"}),e.jsxs("p",{children:["Você começa salvando um usuário num array associativo. Depois precisa validar o e-mail, formatar o nome, gerar um cumprimento. Em pouco tempo, você tem funções soltas operando sobre arrays e ninguém sabe mais a forma exata de cada estrutura. ",e.jsx("strong",{children:"Classe"})," é a resposta: ela junta dados (propriedades) e comportamento (métodos) num molde reutilizável."]}),e.jsx(o,{filename:"usuario_array.php",code:`<?php
