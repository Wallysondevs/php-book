import{j as e}from"./index-B5-q-eol.js";import{P as o,A as s,a}from"./AlertBox-CVbFLZEd.js";import{T as r}from"./TerminalBlock-6fqVIX2R.js";import{C as t}from"./CodeBlock-B36pQ_ak.js";function l(){return e.jsxs(o,{title:"Mocks e Doubles",subtitle:"Como testar código que depende de banco, HTTP ou tempo sem chamar nada de verdade. Stubs, mocks, spies e fakes — quando usar cada um e quando você não deveria estar mockando.",difficulty:"avancado",timeToRead:"13 min",category:"Testes",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Stub"})," "," — "," ","substitui método para devolver valor fixo."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Mock"})," "," — "," ","verifica que método foi chamado com args certos."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Spy"})," "," — "," ","grava chamadas para inspeção posterior."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Fake"})," "," — "," ","implementação simplificada (ex: in-memory repo)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Fixture"})," "," — "," ","dados de teste reutilizáveis."]})]}),e.jsx("h2",{children:"O problema: testes que dependem do mundo"}),e.jsxs("p",{children:["Você tem uma classe ",e.jsx("code",{children:"Notificador"})," que envia e-mail. Para testar a lógica (formatar mensagem, escolher destinatário) você ",e.jsx("em",{children:"não quer"})," mandar e-mail real. Quer testar em milissegundos, sem internet, sem servidor SMTP."]}),e.jsx(a,{filename:"src/Notificador.php",code:`<?php
