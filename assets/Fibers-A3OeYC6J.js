import{j as e}from"./index-Bb4MiiJL.js";import{P as s,a as o,A as r}from"./AlertBox-BpD-xIsb.js";import{T as a}from"./TerminalBlock-DGurMC1r.js";import{C as i}from"./CodeBlock-C3V-qEkN.js";function u(){return e.jsxs(s,{title:"Fibers (PHP 8.1)",subtitle:"Concorrência cooperativa em PHP puro: pause e retome execuções no meio do código sem threads, sem callbacks aninhados — a base sobre a qual amphp/amp e revolt/event-loop foram reescritos.",difficulty:"avancado",timeToRead:"13 min",category:"Async & Fibers",children:[e.jsx("h2",{children:"O problema: 4 chamadas HTTP que somam 4 segundos"}),e.jsxs("p",{children:["Você precisa buscar dados de quatro APIs. Cada chamada leva 1 segundo. Em código síncrono, o total é ",e.jsx("strong",{children:"4 segundos"})," — uma após a outra. Em qualquer linguagem moderna você consegue rodar as quatro em paralelo (concorrência) e terminar em ~1 segundo. PHP, até a versão 8.0, exigia callbacks aninhados de bibliotecas como ReactPHP. O ",e.jsx("strong",{children:"Fiber"})," (PHP 8.1) deu ao PHP a primitiva nativa para isso."]}),e.jsx(o,{filename:"sequencial.php",code:`<?php
...
(
    ...
    [2] => ok: /api/c
    [3] => ok: /api/d
)`}),e.jsx("h2",{children:"O que é uma Fiber, em uma frase"}),e.jsxs("p",{children:["Uma ",e.jsx("strong",{children:"Fiber"})," é uma “função pausável” — ela roda até bater num"," ",e.jsx("code",{children:"Fiber::suspend()"}),", devolve o controle pra quem chamou, e pode ser retomada depois com ",e.jsx("code",{children:"$fiber->resume()"}),". Não é thread, não é processo: é"," ",e.jsx("strong",{children:"cooperação"}),". Quem decide quando trocar de tarefa é o seu código."]}),e.jsxs(r,{type:"info",title:"Fiber NÃO é thread",children:["Fibers rodam ",e.jsx("strong",{children:"no mesmo processo, no mesmo núcleo, em uma única thread"}),". O ganho não vem de paralelismo de CPU — vem de aproveitar o tempo de espera de I/O (banco, rede, disco) para fazer outra coisa."]}),e.jsx("h2",{children:"Hello, Fiber: start, suspend, resume"}),e.jsxs("p",{children:["A API tem três métodos centrais. ",e.jsx("code",{children:"start()"})," roda a fiber até o primeiro"," ",e.jsx("code",{children:"suspend()"}),", devolvendo o que ela passou pra suspender. ",e.jsx("code",{children:"resume()"})," ","retoma a fiber e pode injetar um valor que aparece como retorno do ",e.jsx("code",{children:"suspend()"}),"anterior."]}),e.jsx(o,{filename:"hello.php",code:`<?php
declare(strict_types=1);
...
ok: /api/c
ok: /api/d
Tempo: 1.00 s`}),e.jsxs(r,{type:"warning",title:"Por que isso parece milagre?",children:["Não é. O ganho real depende de ",e.jsx("em",{children:"I/O não bloqueante"})," (streams em modo"," ",e.jsx("code",{children:"stream_set_blocking(false)"}),", sockets assíncronos). Aqui simulamos com"," ",e.jsx("code",{children:"usleep"})," só pra ilustrar o ",e.jsx("em",{children:"shape"})," do código. Em produção, use"," ",e.jsx("code",{children:"revolt/event-loop"})," ou ",e.jsx("code",{children:"amphp/amp"}),"."]}),e.jsx("h2",{children:"O ciclo completo: getReturn(), isSuspended(), isTerminated()"}),e.jsxs("p",{children:["A fiber tem um conjunto de métodos para inspecionar e coletar o resultado final, devolvido com ",e.jsx("code",{children:"return"})," normal:"]}),e.jsx(o,{filename:"ciclo.php",code:`<?php
declare(strict_types=1);
...
Generating autoload files`}),e.jsx(o,{filename:"amphp_http.php",code:`<?php
declare(strict_types=1);
