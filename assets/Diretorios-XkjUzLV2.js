import{j as e}from"./index-Bb4MiiJL.js";import{P as o,a as r,A as a}from"./AlertBox-BpD-xIsb.js";import{T as i}from"./TerminalBlock-DGurMC1r.js";function n(){return e.jsxs(o,{title:"Diretórios e SPL FileInfo",subtitle:"Listar, criar, percorrer e buscar arquivos em árvores inteiras — do clássico scandir até os iteradores recursivos da SPL que substituem find no shell.",difficulty:"intermediario",timeToRead:"12 min",category:"Arquivos & I/O",children:[e.jsx("h2",{children:"O problema: listar o que tem numa pasta"}),e.jsxs("p",{children:["A função mais simples para isso é ",e.jsx("code",{children:"scandir()"}),". Ela devolve um array com todos os nomes de arquivos e subpastas dentro do caminho informado — incluindo os famosos"," ",e.jsx("code",{children:"."})," e ",e.jsx("code",{children:".."})," que você quase sempre quer descartar."]}),e.jsx(r,{filename:"listar.php",code:`<?php
