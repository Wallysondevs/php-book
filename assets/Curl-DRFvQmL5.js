import{j as e}from"./index-Bb4MiiJL.js";import{P as c,a as r,A as o}from"./AlertBox-BpD-xIsb.js";import{T as s}from"./TerminalBlock-DGurMC1r.js";function n(){return e.jsxs(c,{title:"cURL nativo",subtitle:"A API que vem dentro do PHP para fazer HTTP. Verbosa, cheia de constantes, mas zero dependências e roda em qualquer lugar. Aprenda multi-handle, uploads, cookies — e por que muita gente prefere Guzzle.",difficulty:"intermediario",timeToRead:"13 min",category:"HTTP Cliente",children:[e.jsx("h2",{children:"O problema: PHP precisa falar com APIs"}),e.jsxs("p",{children:["Você precisa consumir uma API REST, postar para um webhook, fazer upload de uma imagem para um S3 compatível. O PHP traz cURL embutido (extensão ",e.jsx("code",{children:"ext-curl"}),", ativada por padrão na maioria das distros). É a base que o Guzzle, o WordPress e até o Composer usam por baixo dos panos."]}),e.jsx(r,{filename:"get-simples.php",code:`<?php
