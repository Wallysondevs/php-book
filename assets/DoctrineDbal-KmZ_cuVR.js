import{j as e}from"./index-B5-q-eol.js";import{P as i,A as a,a as o}from"./AlertBox-CVbFLZEd.js";import{T as r}from"./TerminalBlock-6fqVIX2R.js";import{C as t}from"./CodeBlock-B36pQ_ak.js";function d(){return e.jsxs(i,{title:"Doctrine DBAL",subtitle:"Uma camada fina sobre PDO que dá portabilidade real entre SQLite, MySQL e Postgres, um QueryBuilder fluente e tipos automáticos — sem o peso do ORM completo.",difficulty:"intermediario",timeToRead:"13 min",category:"Banco Avançado",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"DBAL"})," "," — "," ","Database Abstraction Layer — camada acima do PDO."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"QueryBuilder"})," "," — "," ","API fluente para montar SQL programaticamente."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Schema Manager"})," "," — "," ","inspeciona/altera schema sem SQL cru."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Types"})," "," — "," ","mapeia tipos do banco ↔ tipos PHP."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"vs ORM"})," "," — "," ","DBAL = SQL fluente; ORM = objetos persistidos."]})]}),e.jsx("h2",{children:"O problema: PDO puro acaba virando colcha de retalhos"}),e.jsxs("p",{children:["PDO funciona, mas você logo descobre dores: o placeholder ",e.jsx("code",{children:"LIMIT ?"})," aceita string em MySQL e int em Postgres, ",e.jsx("code",{children:"BOOLEAN"})," volta como ",e.jsx("code",{children:'"1"'})," em um driver e como"," ",e.jsx("code",{children:"true"})," em outro, e qualquer query com 5 condicionais opcionais vira concatenação de string com ",e.jsx("code",{children:"if"}),". O ",e.jsx("strong",{children:"Doctrine DBAL"})," resolve isso: é uma camada fina sobre o PDO que dá ",e.jsx("em",{children:"portabilidade"}),", ",e.jsx("em",{children:"conversão de tipos"})," e um ",e.jsx("em",{children:"QueryBuilder"})," fluente, sem o peso (e a curva de aprendizado) do ORM completo."]}),e.jsx("h2",{children:"Instalação"}),e.jsx(r,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"composer require doctrine/dbal",output:`./composer.json has been updated
...
Agora:    2025-01-15 13:42:08`}),e.jsx(t,{title:".env",language:"ini",code:`# Dev local
...
Manteiga 200g        R$ 18.00
Pão integral         R$  8.50
Soma dos ativos: R$ 56.4`}),e.jsxs("p",{children:["Com a conexão e o QueryBuilder dominados, o próximo passo é ",e.jsx("strong",{children:"versionar o schema"})," — e é exatamente isso que ",e.jsx("em",{children:"migrations"})," resolvem no próximo capítulo."]})]})}export{d as default};
