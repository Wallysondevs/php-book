import{j as e}from"./index-B5-q-eol.js";import{P as i,A as a,a as s}from"./AlertBox-CVbFLZEd.js";import{T as o}from"./TerminalBlock-6fqVIX2R.js";import{C as r}from"./CodeBlock-B36pQ_ak.js";function d(){return e.jsxs(i,{title:"Checklist de produção",subtitle:"Tudo que precisa estar certo antes de apontar o DNS para o seu servidor: php.ini hardened, sessões fora do disco, HTTPS, backups, monitoramento e estratégia de rollback.",difficulty:"avancado",timeToRead:"14 min",category:"Deploy",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"display_errors=Off"})," "," — "," ","nunca mostre stack para usuário."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"log_errors=On"})," "," — "," ","mande para syslog ou arquivo."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"OPcache"})," "," — "," ","sempre ligado; validate_timestamps=0."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"HTTPS"})," "," — "," ","Let\\u2019s Encrypt + HSTS."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Backups"})," "," — "," ","banco + arquivos + teste de restore."]})]}),e.jsx("h2",{children:"O abismo entre dev e produção"}),e.jsxs("p",{children:["Em desenvolvimento, você quer ver erros gritando na tela. Em produção, mostrar erro para o usuário é ",e.jsx("strong",{children:"vazamento de informação"})," — caminho de arquivo, query SQL, possivelmente até credenciais. Esse capítulo é o checklist final que separa um app amador de um app de verdade."]}),e.jsx("h2",{children:"1. php.ini: a configuração que ninguém revisa"}),e.jsxs("p",{children:["Todo PHP vem com dois templates: ",e.jsx("code",{children:"php.ini-development"})," e",e.jsx("code",{children:" php.ini-production"}),". Em produção, copie o de produção. Mas mesmo ele tem ajustes adicionais que você precisa fazer:"]}),e.jsx(r,{title:"/etc/php/8.4/fpm/php.ini (trechos críticos)",language:"ini",code:`; ============ Erros ============
display_errors = Off
...
opcache.save_comments = 1`}),e.jsxs(a,{type:"danger",title:"O efeito de validate_timestamps = 0",children:["Com isso, o OPcache ",e.jsx("strong",{children:"nunca"})," verifica se o arquivo ",e.jsx("code",{children:".php"})," mudou no disco. Ganho de performance enorme, MAS: depois de cada deploy você",e.jsx("strong",{children:" obrigatoriamente"})," precisa rodar ",e.jsx("code",{children:"systemctl reload php8.4-fpm"})," ","ou ",e.jsx("code",{children:"opcache_reset()"}),". Senão, o servidor continua servindo a versão antiga."]}),e.jsx(s,{filename:"public/info.php",code:`<?php
...
Setting up php8.4-redis (6.1.0) ...`}),e.jsx(r,{title:"/etc/php/8.4/fpm/conf.d/50-session-redis.ini",language:"ini",code:`session.save_handler = redis
...
Redirecting all traffic on port 80 to ssl in /etc/nginx/sites-enabled/loja.conf`}),e.jsx(r,{title:"adicione no server { } HTTPS",language:"nginx",code:`add_header Strict-Transport-Security "max-age=63072000; includeSubDomains; preload" always;
...
}`}),e.jsx(r,{title:".gitignore (mínimo obrigatório)",language:"bash",code:`/.env
/.env.local
/.env.*.local
/vendor/
/node_modules/
