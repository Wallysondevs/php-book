import{j as e}from"./index-Bb4MiiJL.js";import{P as o,a as s,A as a}from"./AlertBox-BpD-xIsb.js";import{T as r}from"./TerminalBlock-DGurMC1r.js";function d(){return e.jsxs(o,{title:"Senhas: hash & verify",subtitle:"Como guardar senhas de usuários do jeito certo em PHP — password_hash, password_verify, password_needs_rehash e por que md5/sha1 são pecado mortal.",difficulty:"intermediario",timeToRead:"12 min",category:"Segurança",children:[e.jsx("h2",{children:"O problema: o banco vaza. E aí?"}),e.jsxs("p",{children:["Cedo ou tarde, alguém vaza o seu banco de dados — SQL injection, backup mal configurado, ex-funcionário descontente. A pergunta não é ",e.jsx("em",{children:"se"}),", é"," ",e.jsx("em",{children:"quando"}),". E a única defesa que sobra naquele momento é como você guardou as senhas. Se elas estavam em texto puro (ou num hash fraco como MD5/SHA1), o atacante já tem todas as contas."]}),e.jsx(s,{filename:"errado.php",code:`<?php
