import{j as e}from"./index-Bb4MiiJL.js";import{P as a,a as s,A as r}from"./AlertBox-BpD-xIsb.js";import{T as o}from"./TerminalBlock-DGurMC1r.js";import{B as i}from"./BrowserBlock-C5ENTT0j.js";function l(){return e.jsxs(a,{title:"Servidor embutido (php -S)",subtitle:"Suba um servidor web de desenvolvimento em 1 segundo, sem instalar Apache ou Nginx. Aprenda quando vale a pena, como roteador customizado funciona, e por que NUNCA usar isso em produção.",difficulty:"iniciante",timeToRead:"8 min",category:"Instalação",children:[e.jsx("h2",{children:"Um servidor em uma linha"}),e.jsx("p",{children:"Antes de qualquer teoria, veja a coisa mais útil que você vai aprender hoje:"}),e.jsx(o,{user:"dev",host:"php",cwd:"~/projeto",command:"php -S localhost:8000",output:`[Wed Jan 15 10:00:00 2026] PHP 8.4.1 Development Server (http://localhost:8000) started
Listening on http://localhost:8000
Document root is /home/dev/projeto
Press Ctrl-C to quit.`}),e.jsxs("p",{children:["Pronto. Você tem um servidor web rodando, sem Apache, sem Nginx, sem virtual host. Crie um",e.jsx("code",{children:" index.php"})," nesse diretório e abra ",e.jsx("code",{children:"http://localhost:8000"}),":"]}),e.jsx(s,{filename:"index.php",code:`<?php
...
Listening on http://localhost:8000
Document root is /home/dev/projeto/public
Press Ctrl-C to quit.`}),e.jsxs("p",{children:["Aqui o ",e.jsx("em",{children:"último"})," argumento é o ",e.jsx("strong",{children:"router"}),": um script que decide o que fazer com cada request. Ele recebe a URL no ",e.jsx("code",{children:"$_SERVER"})," e ou retorna ",e.jsx("code",{children:"false"})," ","(deixando o servidor servir o arquivo estático) ou imprime a resposta:"]}),e.jsx(s,{filename:"public/index.php",code:`<?php
declare(strict_types=1);
...
[Wed Jan 15 10:09:05 2026] 192.168.0.42:54100 [200]: GET /relatorio_q4.pdf`}),e.jsx("h3",{children:"Roteador que loga tudo (sem mexer no app)"}),e.jsx(s,{filename:"logger.php",code:`<?php
declare(strict_types=1);
