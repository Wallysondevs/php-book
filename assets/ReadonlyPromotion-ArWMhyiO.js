import{j as e}from"./index-B5-q-eol.js";import{P as i,A as o,a}from"./AlertBox-CVbFLZEd.js";import{T as r}from"./TerminalBlock-6fqVIX2R.js";function d(){return e.jsxs(i,{title:"Readonly & Constructor Promotion",subtitle:"Duas features pequenas que mudam radicalmente como você escreve DTOs, value objects e entidades imutáveis no PHP moderno.",difficulty:"intermediario",timeToRead:"10 min",category:"PHP Moderno",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"readonly (8.1)"})," "," — "," ","propriedade só pode ser escrita uma vez (no constructor)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Promotion (8.0)"})," "," — "," ","public function __construct(private int $x) — declara e atribui."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"readonly class (8.2)"})," "," — "," ","todas as props da classe ficam readonly."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Imutabilidade"})," "," — "," ","evita estados inconsistentes; força clone para modificar."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"with()"})," "," — "," ","padrão: método retorna nova instância com a alteração."]})]}),e.jsx("h2",{children:"O problema: classes simples com 30 linhas de boilerplate"}),e.jsxs("p",{children:["No PHP antigo, criar uma classe imutável de três campos exigia: declarar propriedades, declarar parâmetros do construtor, atribuir um a um. Toda essa cerimônia para algo que, semanticamente, é um ",e.jsx("em",{children:"record"}),"."]}),e.jsx(a,{filename:"legado.php",code:`<?php
