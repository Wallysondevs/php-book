import{j as e}from"./index-B5-q-eol.js";import{P as s,A as o,a}from"./AlertBox-CVbFLZEd.js";import{B as r}from"./BrowserBlock-pEcgE37D.js";import{C as i}from"./CodeBlock-B36pQ_ak.js";function c(){return e.jsxs(s,{title:"Upload de arquivos",subtitle:"Receber arquivos do usuário sem virar manchete de invasão: validação de tipo MIME real, limites do php.ini, defesa contra path traversal e múltiplos uploads.",difficulty:"intermediario",timeToRead:"13 min",category:"Arquivos & I/O",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"$_FILES"})," "," — "," ","array com tmp_name, name, size, error."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"move_uploaded_file()"})," "," — "," ","só move se foi upload real (verifica is_uploaded_file)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"MIME"})," "," — "," ",'finfo_file detecta tipo real — não confie em $_FILES["type"].']}),e.jsxs("li",{children:[e.jsx("strong",{children:"Limites"})," "," — "," ","upload_max_filesize e post_max_size no php.ini."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Segurança"})," "," — "," ","nunca aceite extensões executáveis; randomize nome."]})]}),e.jsx("h2",{children:"O ponto de partida: o formulário HTML"}),e.jsxs("p",{children:["O navegador só envia um arquivo se o formulário tiver"," ",e.jsx("code",{children:'enctype="multipart/form-data"'})," e o input for"," ",e.jsx("code",{children:'type="file"'}),". Esquecer o ",e.jsx("code",{children:"enctype"})," é a fonte número um de upload que “não chega no PHP”."]}),e.jsx(i,{language:"bash",title:"upload.html",code:`<form action="/upload.php" method="POST" enctype="multipart/form-data">
  <input type="file" name="avatar" accept="image/*" required>
  <button type="submit">Enviar</button>
</form>`}),e.jsx(r,{url:"http://localhost:8000/upload.html",children:e.jsxs("form",{className:"space-y-3",children:[e.jsx("div",{children:e.jsx("input",{type:"file",disabled:!0,className:"text-sm"})}),e.jsx("button",{type:"button",disabled:!0,className:"px-4 py-2 bg-blue-600 text-white rounded text-sm",children:"Enviar"})]})}),e.jsx("h2",{children:"$_FILES: o que o PHP te entrega"}),e.jsxs("p",{children:["Quando o upload chega, o PHP popula o superglobal ",e.jsx("code",{children:"$_FILES"}),". Ele é um array associativo com cinco chaves por arquivo:"]}),e.jsx(a,{filename:"ver-files.php",code:`<?php
...
)`}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"name"})," — nome original (vem do cliente, ",e.jsx("strong",{children:"nunca confie"}),")."]}),e.jsxs("li",{children:[e.jsx("code",{children:"type"})," — MIME informado pelo cliente (também ",e.jsx("strong",{children:"não confie"}),")."]}),e.jsxs("li",{children:[e.jsx("code",{children:"tmp_name"})," — caminho temporário onde o PHP gravou o upload."]}),e.jsxs("li",{children:[e.jsx("code",{children:"error"})," — código ",e.jsx("code",{children:"UPLOAD_ERR_*"})," (0 = sucesso)."]}),e.jsxs("li",{children:[e.jsx("code",{children:"size"})," — tamanho em bytes."]})]}),e.jsxs(o,{type:"danger",title:"O que o cliente manda é apenas DICA",children:["Tanto ",e.jsx("code",{children:"name"})," quanto ",e.jsx("code",{children:"type"})," vêm do navegador. Um atacante pode enviar um ",e.jsx("code",{children:".php"})," chamado ",e.jsx("code",{children:"foto.png"})," com"," ",e.jsx("code",{children:"type: image/png"}),". Sua defesa precisa olhar o ",e.jsx("strong",{children:"conteúdo real"})," ","do arquivo — vamos ver com ",e.jsx("code",{children:"finfo"})," daqui a pouco."]}),e.jsx("h2",{children:"O fluxo correto: move_uploaded_file"}),e.jsxs("p",{children:["O arquivo chega num diretório temporário e o PHP apaga ele no fim do request. Para guardar, você usa ",e.jsx("code",{children:"move_uploaded_file()"})," — não ",e.jsx("code",{children:"rename()"}),", não"," ",e.jsx("code",{children:"copy()"}),". ",e.jsx("code",{children:"move_uploaded_file"})," verifica que o arquivo realmente veio de upload HTTP, evitando truques onde alguém aponta para ",e.jsx("code",{children:"/etc/passwd"}),"."]}),e.jsx(a,{filename:"upload-basico.php",code:`<?php
declare(strict_types=1);
...
echo "Salvo em: " . basename($destino) . PHP_EOL;`,output:"Salvo em: 9f3a2b1c8d4e7f6a0b1c2d3e4f5a6b7c.png"}),e.jsxs(o,{type:"success",title:"Por que random_bytes para nome?",children:["Usar o ",e.jsx("code",{children:"name"})," original deixa você vulnerável a path traversal (",e.jsx("code",{children:"../../etc/passwd"}),") e colisão (dois usuários enviando “foto.png”). Um nome aleatório resolve os dois problemas de uma vez."]}),e.jsx("h2",{children:"Decodificando os erros"}),e.jsxs("p",{children:["Quando o upload falha, o código em ",e.jsx("code",{children:"$_FILES['x']['error']"})," te diz por quê. Vale ter um ",e.jsx("code",{children:"match"})," à mão:"]}),e.jsx(a,{filename:"erros-upload.php",code:`<?php
declare(strict_types=1);
...
Nenhum arquivo enviado`}),e.jsx("h2",{children:"Validando o MIME real com finfo"}),e.jsxs("p",{children:["A extensão ",e.jsx("code",{children:"fileinfo"})," (vem ligada por padrão) lê os primeiros bytes do arquivo e identifica o tipo de verdade — independente do que o cliente disse:"]}),e.jsx(a,{filename:"upload-validado.php",code:`<?php
declare(strict_types=1);
