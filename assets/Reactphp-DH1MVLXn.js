import{j as e}from"./index-Bb4MiiJL.js";import{P as a,a as o,A as s}from"./AlertBox-BpD-xIsb.js";import{T as r}from"./TerminalBlock-DGurMC1r.js";import{B as t}from"./BrowserBlock-C5ENTT0j.js";import{C as n}from"./CodeBlock-C3V-qEkN.js";function m(){return e.jsxs(a,{title:"ReactPHP — event loop",subtitle:"PHP assíncrono de verdade: um event loop em cima de stream_select, promises e I/O não-bloqueante. O mesmo modelo que faz o Node.js voar, agora dentro do seu PHP 8.4.",difficulty:"avancado",timeToRead:"13 min",category:"Async & Fibers",children:[e.jsx("h2",{children:"O problema: 10 chamadas HTTP que demoram uma eternidade"}),e.jsx("p",{children:"Imagine que você precisa consultar 10 APIs externas e juntar os resultados. Em PHP síncrono clássico, cada chamada bloqueia a próxima. Se cada uma leva 1 segundo, você espera 10 segundos em série. Não tem CPU envolvida — é tudo I/O, esperando o socket responder."}),e.jsx(o,{filename:"sincrono.php",code:`<?php
