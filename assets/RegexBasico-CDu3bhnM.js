...
int(1)
int(1)
int(0)`}),e.jsxs(o,{type:"warning",title:"Validação SEMPRE com ^ e $",children:["Para validar entrada de usuário, use ",e.jsx("code",{children:"^...$"}),". Para extrair pedaços de uma string maior, omita as âncoras. Esquecer isso é um clássico que abre brechas de validação."]}),e.jsx("h2",{children:"preg_match_all: pegar todas as ocorrências"}),e.jsxs("p",{children:["Quando você quer todos os matches (não só o primeiro), use ",e.jsx("code",{children:"preg_match_all()"}),"."]}),e.jsx(a,{filename:"match-all.php",code:`<?php
declare(strict_types=1);
