...
Versão: 1.0`}),e.jsxs(a,{type:"warning",title:"Sempre cheque o retorno",children:[e.jsx("code",{children:"file_get_contents()"})," retorna ",e.jsx("code",{children:"false"})," em erro (arquivo inexistente, sem permissão). Em PHP moderno você também pode habilitar exceções com"," ",e.jsx("code",{children:"set_error_handler"}),", mas o ",e.jsx("code",{children:"=== false"})," é o idioma mais usado."]}),e.jsxs("p",{children:["Para gravar, o gêmeo ",e.jsx("code",{children:"file_put_contents()"})," aceita uma string e devolve quantos bytes escreveu. Por padrão ele ",e.jsx("strong",{children:"sobrescreve"})," o arquivo:"]}),e.jsx(o,{filename:"gravar-config.php",code:`<?php
declare(strict_types=1);
...
echo lerSeguro('/var/dados/relatorio.txt');`,output:"Relatório do mês: tudo certo!"}),e.jsxs("p",{children:["O ",e.jsx("code",{children:"realpath()"})," resolve ",e.jsx("code",{children:".."}),", links simbólicos e caminhos relativos — fundamental para evitar ",e.jsx("em",{children:"path traversal"}),", que vamos detalhar no capítulo de uploads."]}),e.jsx("h2",{children:"Rodando os exemplos"}),e.jsx(i,{user:"dev",host:"php",cwd:"~/projetos/io",command:"php processa-csv.php",output:`Linhas processadas: 50000
