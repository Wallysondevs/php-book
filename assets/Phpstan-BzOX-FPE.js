import{j as e}from"./index-B5-q-eol.js";import{P as a,A as o,a as r}from"./AlertBox-CVbFLZEd.js";import{T as s}from"./TerminalBlock-6fqVIX2R.js";import{C as n}from"./CodeBlock-B36pQ_ak.js";function d(){return e.jsxs(a,{title:"PHPStan — análise estática",subtitle:"O compilador que o PHP nunca teve. Encontra bugs antes de você rodar o código, valida tipos, generics em PHPDoc e te força a escrever PHP profissional.",difficulty:"avancado",timeToRead:"14 min",category:"Qualidade",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"PHPStan"})," "," — "," ","análise estática — encontra bugs sem rodar código."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Levels"})," "," — "," ","0 a 9 (ou max); aumente gradualmente."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"baseline"})," "," — "," ","congela erros existentes para corrigir aos poucos."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Generics"})," "," — "," ","documente em docblock para PHPStan inferir tipos."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"vs Psalm"})," "," — "," ","concorrente direto; APIs semelhantes."]})]}),e.jsx("h2",{children:"O problema: PHP só reclama em runtime"}),e.jsxs("p",{children:["Em linguagens compiladas, o compilador grita antes do código rodar. Em PHP, você só descobre que chamou um método inexistente ",e.jsx("em",{children:"quando o usuário clica no botão em produção"}),". O"," ",e.jsx("strong",{children:"PHPStan"})," resolve isso fazendo análise estática: lê seu código sem executar e aponta erros de tipo, métodos inexistentes, propriedades nulas, branches mortos e muito mais."]}),e.jsx("h2",{children:"Instalação"}),e.jsx(s,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"composer require --dev phpstan/phpstan",output:`Using version ^1.12 for phpstan/phpstan
...
Generating autoload files`}),e.jsxs("p",{children:["Pronto, você ganhou o binário ",e.jsx("code",{children:"vendor/bin/phpstan"}),". Vamos rodar contra um arquivo propositalmente bugado:"]}),e.jsx(r,{filename:"src/Carrinho.php",code:`<?php
...
}`}),e.jsx(s,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"vendor/bin/phpstan analyse src --level=9",output:`Note: Using configuration file /home/dev/projetos/loja/phpstan.neon.
 ...
 [ERROR] Found 1 error`}),e.jsxs("p",{children:["Sem rodar o código, o PHPStan já encontrou o typo ",e.jsx("code",{children:"$item['precoo']"}),". Ele leu o PHPDoc ",e.jsxs("code",{children:["array","{nome: string, preco: float}"]})," e validou cada acesso de chave. Isso é ouro."]}),e.jsx("h2",{children:"Os níveis: do leve ao paranóico"}),e.jsxs("p",{children:["O PHPStan tem 10 níveis (0 a 9 + ",e.jsx("code",{children:"max"}),"). Cada um adiciona checagens mais rígidas. Resumo prático:"]}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"0"})," — checagens básicas, classes/métodos inexistentes."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"5"})," — tipos de argumentos em chamadas de método."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"7"})," — checa ",e.jsx("code",{children:"null"})," em todo lugar (sai do modo permissivo)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"9"})," — proibe uso de ",e.jsx("code",{children:"mixed"})," sem narrowing."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"max"})," — alias para o nível mais alto disponível na versão."]})]}),e.jsxs(o,{type:"info",title:"Estratégia recomendada",children:["Comece em ",e.jsx("code",{children:"level 0"}),", zere os erros, suba para ",e.jsx("code",{children:"1"}),", repita. Em projeto novo, mire ",e.jsx("code",{children:"level 9"})," desde o dia zero."]}),e.jsx("h2",{children:"Configuração com phpstan.neon"}),e.jsxs("p",{children:["Em vez de passar flags toda hora, crie um ",e.jsx("code",{children:"phpstan.neon"})," na raiz do projeto. O formato NEON é parecido com YAML:"]}),e.jsx(n,{language:"yaml",title:"phpstan.neon",code:`parameters:
    ...
    ignoreErrors:
        ...
        -
            ...
            paths:
                - src/Legacy/*`}),e.jsxs("p",{children:["Agora basta rodar ",e.jsx("code",{children:"vendor/bin/phpstan analyse"})," sem argumentos — ele lê o NEON automaticamente."]}),e.jsx("h2",{children:"Generics em PHPDoc"}),e.jsxs("p",{children:["PHP não tem generics na sintaxe da linguagem, mas o PHPStan entende generics escritos no"," ",e.jsx("code",{children:"@template"})," do PHPDoc. Veja um repositório genérico de verdade:"]}),e.jsx(r,{filename:"src/Repository.php",code:`<?php
declare(strict_types=1);
...
echo $u?->nome ?? 'não achou';`,output:"não achou"}),e.jsxs("p",{children:["Repare: ",e.jsx("code",{children:"$repo->find(1)"})," tem retorno ",e.jsx("code",{children:"?object"})," na assinatura, mas graças ao ",e.jsx("code",{children:"@template T"})," + ",e.jsx("code",{children:"@extends Repository<Usuario>"}),", o PHPStan infere que o retorno real é ",e.jsx("code",{children:"Usuario|null"}),". Você ganha autocomplete correto e checagem de tipos sem mudar uma vírgula da linguagem."]}),e.jsx("h2",{children:"Tipos avançados que só PHPStan entende"}),e.jsx("p",{children:"O PHPStan trouxe um vocabulário de tipos que o PHP nativo não tem. Os mais úteis no dia a dia:"}),e.jsx(r,{filename:"src/Tipos.php",code:`<?php
declare(strict_types=1);
...
parameters:
    level: 9
    paths:
        - src`}),e.jsx("p",{children:"Daqui pra frente: código novo é checado no nível 9; código antigo continua livre. Conforme você refatora, regenera o baseline e o número diminui. É a única estratégia humana de adoção em projeto grande."}),e.jsxs(o,{type:"warning",title:"Não vire viciado em baseline",children:["Baseline é remédio, não dieta. Marque no calendário pra ",e.jsx("strong",{children:"regenerar"})," ele toda sprint — caso contrário ele só cresce."]}),e.jsx("h2",{children:"ignoreErrors pontual"}),e.jsxs("p",{children:["Para casos isolados (uma extensão exótica, uma magia inevitável), use"," ",e.jsx("code",{children:"ignoreErrors"})," direcionado em vez de baseline:"]}),e.jsx(n,{language:"yaml",title:"phpstan.neon",code:`parameters:
    ignoreErrors:
