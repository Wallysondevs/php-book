import{j as e}from"./index-B5-q-eol.js";import{P as r,A as a,a as o}from"./AlertBox-CVbFLZEd.js";import{T as s}from"./TerminalBlock-6fqVIX2R.js";function t(){return e.jsxs(r,{title:"Closures avançadas",subtitle:"Vai além do básico: bind/bindTo para trocar o $this, first-class callable syntax, currying e memoização — as ferramentas funcionais que faltavam no seu cinto.",difficulty:"avancado",timeToRead:"12 min",category:"Reflection & Meta",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"use() lexical"})," "," — "," ","lista variáveis do escopo pai a importar; por valor por padrão."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"$this em closure"})," "," — "," ","closures dentro de classes ligam $this automaticamente."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Closure::bind()"})," "," — "," ","religa $this/escopo de uma closure a outro objeto."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Closure::fromCallable()"})," "," — "," ","transforma callable (string ou array) em objeto Closure."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"First-class callable (8.1)"})," "," — "," ","strlen(...) cria uma Closure a partir de qualquer função."]})]}),e.jsx("h2",{children:"Recapitulando: o que é uma Closure?"}),e.jsxs("p",{children:["Toda função anônima em PHP é, na prática, uma instância da classe nativa"," ",e.jsx("code",{children:"Closure"}),". Isso significa que ela é um objeto, pode ser passada como argumento, retornada de funções, armazenada em propriedades — e, o mais interessante,"," ",e.jsxs("strong",{children:["tem um ",e.jsx("code",{children:"$this"})," próprio"]})," que você pode reescrever em runtime."]}),e.jsx(o,{filename:"closure_objeto.php",code:`<?php
