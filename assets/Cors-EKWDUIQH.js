import{j as e}from"./index-Bb4MiiJL.js";import{P as i,A as o,a as s}from"./AlertBox-BpD-xIsb.js";import{T as a}from"./TerminalBlock-DGurMC1r.js";import{C as r}from"./CodeBlock-C3V-qEkN.js";function c(){return e.jsxs(i,{title:"CORS na prática",subtitle:"Por que o navegador bloqueia sua API, o que é preflight, quais headers responder e como debugar o famoso 'blocked by CORS policy' sem chorar.",difficulty:"intermediario",timeToRead:"11 min",category:"APIs REST",children:[e.jsx("h2",{children:"O problema: o navegador é paranoico (de propósito)"}),e.jsxs("p",{children:["Você terminou a API em ",e.jsx("code",{children:"http://api.exemplo.com"}),", abriu o frontend em ",e.jsx("code",{children:"http://app.exemplo.com"}),", fez ",e.jsx("code",{children:"fetch()"}),"... e o console cuspiu:"]}),e.jsx(r,{language:"bash",code:`Access to fetch at 'http://api.exemplo.com/v1/users'
...
]);`,output:'{"users":[{"id":1,"name":"Ada"},{"id":2,"name":"Linus"}]}'}),e.jsx(a,{user:"dev",host:"api",cwd:"~/projeto",command:"curl -i -H 'Origin: https://app.exemplo.com' http://localhost:8000/v1/users",output:`HTTP/1.1 200 OK
