import{j as e}from"./index-Bb4MiiJL.js";import{P as n,a,A as o}from"./AlertBox-BpD-xIsb.js";import{T as s}from"./TerminalBlock-DGurMC1r.js";function d(){return e.jsxs(n,{title:"Enums (PHP 8.1)",subtitle:"Adeus às constantes soltas e aos magic strings: enums dão tipo, autocomplete e métodos para conjuntos finitos de valores como status, papéis e tipos de pagamento.",difficulty:"intermediario",timeToRead:"11 min",category:"PHP Moderno",children:[e.jsx("h2",{children:"O problema: constantes soltas e strings mágicas"}),e.jsx("p",{children:"Antes do PHP 8.1, era comum modelar status de pedido com constantes de classe ou — pior — strings cruas espalhadas pelo código. Resultado: erros de digitação viravam bugs silenciosos e o IDE não conseguia ajudar com autocomplete."}),e.jsx(a,{filename:"legado.php",code:`<?php
...
Aprovado`}),e.jsxs("p",{children:["Toda instância de enum tem a propriedade mágica ",e.jsx("code",{children:"name"})," que devolve o nome do caso como string. Use isso para logar/exibir, mas evite reconstruir o enum a partir do ",e.jsx("code",{children:"name"})," — para serializar, prefira ",e.jsx("em",{children:"backed enums"}),"."]}),e.jsx("h2",{children:"Backed enums: cada caso tem um valor"}),e.jsxs("p",{children:["Quando você precisa salvar o estado em banco, JSON ou query string, declara o enum com um tipo escalar — ",e.jsx("code",{children:"string"})," ou ",e.jsx("code",{children:"int"})," — e atribui um ",e.jsx("code",{children:"value"})," a cada caso."]}),e.jsx(a,{filename:"papel.php",code:`<?php
declare(strict_types=1);
...
cancelado: Cancelado pelo cliente (cancelar? não)`}),e.jsxs(o,{type:"success",title:"match esgota o enum",children:["Quando o ",e.jsx("code",{children:"match"})," cobre todos os casos do enum, o PHP ",e.jsx("em",{children:"e"})," ","ferramentas como PHPStan garantem que você não esqueceu nenhum. Adicionou um novo caso? O analisador estático aponta exatamente onde faltou tratamento."]}),e.jsx("h2",{children:"Enums implementam interfaces"}),e.jsx("p",{children:"Como qualquer classe, um enum pode implementar uma ou mais interfaces. Isso é muito útil para padronizar contratos (ex.: tudo que pode ser exibido em uma UI)."}),e.jsx(a,{filename:"interface.php",code:`<?php
declare(strict_types=1);
