...
}`}),e.jsx(s,{type:"warning",title:"Custo em produção",children:"Validação em todo request adiciona ~2-5ms por chamada. Em alta carga, valide só requests (entrada do usuário) e deixe a validação de response apenas em CI ou staging."}),e.jsx("h2",{children:"Gerando SDK cliente automaticamente"}),e.jsxs("p",{children:["Esse é o ganho real: você escreve o YAML uma vez e gera SDKs para TypeScript, Python, Go, Java, Kotlin, C#... O ",e.jsx("code",{children:"openapi-generator"})," tem 50+ targets. Use Docker para não poluir sua máquina:"]}),e.jsx(o,{user:"dev",host:"api",cwd:"~/projeto",command:'docker run --rm -v "$PWD:/local" openapitools/openapi-generator-cli generate -i /local/public/openapi.yaml -g typescript-fetch -o /local/sdk/ts',output:`[main] INFO  o.o.codegen.DefaultGenerator - Generating with dryRun=false
...
################################################################################`}),e.jsxs("p",{children:["Pronto: o frontend faz ",e.jsxs("code",{children:["import ","{ UsersApi }"," from './sdk/ts'"]})," e chama ",e.jsxs("code",{children:["api.listUsers(","{ limit: 20 }",")"]})," com tipos TypeScript completos. Quando você muda o YAML, regera e o TS quebra a build se algo virou breaking change."]}),e.jsx("h2",{children:"Lint e CI: openapi-cli"}),e.jsxs("p",{children:["O ",e.jsx("code",{children:"@redocly/cli"})," valida estrutura, detecta erros comuns (path duplicado, ref quebrada, schema sem exemplo) e gera docs estáticas. Coloque no CI:"]}),e.jsx(o,{user:"dev",host:"api",cwd:"~/projeto",command:"npx @redocly/cli lint public/openapi.yaml",output:`validating public/openapi.yaml...
public/openapi.yaml: validated in 142ms

Woohoo! Your API description is valid. 🎉`}),e.jsx(o,{user:"dev",host:"api",cwd:"~/projeto",command:"npx @redocly/cli build-docs public/openapi.yaml -o public/docs.html",output:`Prerendering docs
