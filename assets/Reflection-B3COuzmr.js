import{j as e}from"./index-B5-q-eol.js";import{P as i,A as a,a as o}from"./AlertBox-CVbFLZEd.js";import{T as r}from"./TerminalBlock-6fqVIX2R.js";function c(){return e.jsxs(i,{title:"Reflection API",subtitle:"A capacidade do PHP de inspecionar a si mesmo em tempo de execução: ler classes, métodos, propriedades e atributos para construir frameworks, ORMs e containers de DI.",difficulty:"avancado",timeToRead:"13 min",category:"Reflection & Meta",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"ReflectionClass"})," "," — "," ","inspeciona métodos, props e atributos em runtime."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"ReflectionMethod"})," "," — "," ","pega assinatura e invoca métodos privados."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Performance"})," "," — "," ","reflection é cara — evite em hot paths."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Uso típico"})," "," — "," ","frameworks de DI, ORMs e serializers."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Atributos (8.0)"})," "," — "," ","#[Attr] é lido via getAttributes()."]})]}),e.jsx("h2",{children:"O problema: quero instanciar uma classe sem saber o que ela precisa"}),e.jsxs("p",{children:["Imagine escrever um container de injeção de dependências. Você recebe o nome de uma classe e precisa instanciá-la, descobrindo automaticamente o que o construtor pede. Sem reflexão, você teria que codar uma fábrica para cada classe. Com ",e.jsx("code",{children:"ReflectionClass"}),", o PHP te conta tudo que sabe sobre qualquer tipo carregado."]}),e.jsx(o,{filename:"primeiro_olhar.php",code:`<?php
...
Reflexão : 38.64 ms (9.2x mais lento)`}),e.jsxs(a,{type:"danger",title:"Cacheie em produção",children:["Frameworks sérios ",e.jsx("strong",{children:"compilam"})," a resolução do container em arquivo PHP plano para o ambiente de produção (Symfony) ou cacheiam o resultado da reflexão (Laravel). Nunca deixe reflexão crua no caminho quente de uma request."]}),e.jsx("h2",{children:"Rodando os exemplos"}),e.jsx(r,{user:"dev",host:"php",cwd:"~/reflection",command:"php MiniContainer.php",output:"[log] email -> ada@example.com"}),e.jsxs("p",{children:["No próximo capítulo a gente fecha a trinca da metaprogramação com"," ",e.jsx("strong",{children:"closures avançadas"})," — bind, fromCallable e a sintaxe first-class callable do PHP 8.1."]})]})}export{c as default};
