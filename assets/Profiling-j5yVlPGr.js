...
Installing blackfire.so for PHP 8.4`}),e.jsx(s,{language:"ini",code:`; /etc/php/8.4/fpm/conf.d/zz-blackfire.ini
...
Memory     18.2MB
SQL        102ms`}),e.jsxs(r,{type:"info",title:"Performance budget no CI",children:["O grande charme do Blackfire é o ",e.jsx("strong",{children:"blackfire-player"}),": você escreve cenários YAML e adiciona ",e.jsx("em",{children:"assertions"})," tipo",e.jsx("code",{children:" main.wall_time < 200ms"})," ou",e.jsx("code",{children:" metrics.sql.queries.count < 10"}),". O CI quebra se uma PR introduz regressão de performance."]}),e.jsx(s,{language:"yaml",code:`# scenario.bkf
scenario
...
Build complete.`}),e.jsx(s,{language:"ini",code:`; /etc/php/8.4/conf.d/zz-spx.ini
extension=spx.so
