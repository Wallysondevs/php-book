import{j as e}from"./index-Bb4MiiJL.js";import{P as r,a as s,A as t}from"./AlertBox-BpD-xIsb.js";import{T as a}from"./TerminalBlock-DGurMC1r.js";import{C as o}from"./CodeBlock-C3V-qEkN.js";function p(){return e.jsxs(r,{title:"PHPUnit",subtitle:"O framework de testes mais maduro do PHP. Vamos instalar, configurar, escrever os primeiros casos, usar dataProviders e gerar relatório de cobertura HTML.",difficulty:"intermediario",timeToRead:"14 min",category:"Testes",children:[e.jsx("h2",{children:"Por que PHPUnit?"}),e.jsxs("p",{children:["Você acabou de implementar uma função que calcula desconto. Roda no navegador, parece certo. Daqui a três meses um colega mexe em outra parte do código e seu desconto começa a vir negativo. Sem teste, ninguém percebe — o cliente percebe. Esse é o problema que o ",e.jsx("strong",{children:"PHPUnit"})," resolve: cada regra de negócio vira código executável que ",e.jsx("em",{children:"protege"})," a próxima alteração."]}),e.jsx("h2",{children:"Instalando como dependência de dev"}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"composer require --dev phpunit/phpunit ^11.0",output:`Using version ^11.0 for phpunit/phpunit
...
</phpunit>`}),e.jsx("h2",{children:"Primeiro teste — uma calculadora simples"}),e.jsx(s,{filename:"src/Calculadora.php",code:`<?php
...
}`}),e.jsx(s,{filename:"tests/CalculadoraTest.php",code:`<?php
declare(strict_types=1);
...
}`}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"./vendor/bin/phpunit",output:`PHPUnit 11.4.3 by Sebastian Bergmann and contributors.
...
OK (2 tests, 2 assertions)`}),e.jsxs(t,{type:"success",title:"Convenção de nomes",children:["Use ",e.jsx("code",{children:"NomeDaClasseTest"})," e métodos começando com ",e.jsx("code",{children:"test_"})," ou anotados com"," ",e.jsx("code",{children:"#[Test]"}),". PHPUnit 11 abandonou anotações em docblock — agora tudo é"," ",e.jsx("strong",{children:"atributo nativo do PHP 8"}),"."]}),e.jsx("h2",{children:"assertEquals vs assertSame"}),e.jsxs("p",{children:["Esta é ",e.jsx("strong",{children:"a"})," pegadinha mais comum. Ambos comparam, mas:"]}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"assertEquals"})," usa ",e.jsx("code",{children:"=="})," (faz coerção de tipos)."]}),e.jsxs("li",{children:[e.jsx("code",{children:"assertSame"})," usa ",e.jsx("code",{children:"==="})," (compara tipo E valor)."]})]}),e.jsx(s,{filename:"tests/IgualdadeTest.php",code:`<?php
declare(strict_types=1);
...
OK (3 tests, 5 assertions)`}),e.jsxs(t,{type:"warning",title:"Prefira assertSame por padrão",children:[e.jsx("code",{children:"assertEquals"})," esconde bugs de tipo. Em código com ",e.jsx("code",{children:"declare(strict_types=1)"}),", praticamente nunca faz sentido aceitar coerção. Use ",e.jsx("code",{children:"assertSame"})," e suas variações estritas (",e.jsx("code",{children:"assertCount"}),", ",e.jsx("code",{children:"assertInstanceOf"}),") sempre que possível."]}),e.jsx("h2",{children:"Data Providers — testando 50 casos com 1 método"}),e.jsxs("p",{children:["Em vez de copiar e colar o mesmo teste para 5 valores diferentes, você fornece os dados via"," ",e.jsx("code",{children:"#[DataProvider]"}),":"]}),e.jsx(s,{filename:"tests/SomaTest.php",code:`<?php
declare(strict_types=1);
...
OK (2 tests, 2 assertions)`}),e.jsxs(t,{type:"info",title:"Cada teste é um mundo isolado",children:["PHPUnit cria ",e.jsx("strong",{children:"uma nova instância"})," da classe de teste para cada método. Estado em propriedades nunca vaza entre testes — exatamente o que você quer."]}),e.jsx("h2",{children:"Filtrando: rodando só um teste"}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"./vendor/bin/phpunit --filter test_soma",output:`PHPUnit 11.4.3 by Sebastian Bergmann and contributors.

.....                                                               5 / 5 (100%)

Time: 00:00.011, Memory: 8.00 MB

OK (5 tests, 5 assertions)`}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"./vendor/bin/phpunit tests/CarrinhoTest.php",output:`PHPUnit 11.4.3 by Sebastian Bergmann and contributors.

..                                                                  2 / 2 (100%)

OK (2 tests, 2 assertions)`}),e.jsx("h2",{children:"Cobertura de código com Xdebug"}),e.jsxs("p",{children:["Cobertura responde: ",e.jsx("em",{children:"quais linhas do meu código são executadas pelos testes?"})," Para gerar relatório HTML, você precisa do Xdebug (ou pcov) instalado."]}),e.jsx(a,{user:"dev",host:"php",cwd:"~/projetos/loja",command:"XDEBUG_MODE=coverage ./vendor/bin/phpunit --coverage-html coverage",output:`PHPUnit 11.4.3 by Sebastian Bergmann and contributors.
...
./vendor/bin/phpunit --stop-on-failure`}),e.jsxs("p",{children:["No próximo capítulo a gente conhece o ",e.jsx("strong",{children:"Pest"}),", uma camada moderna em cima do PHPUnit que troca classes e métodos por uma sintaxe quase narrativa — ",e.jsx("code",{children:"it('soma corretamente', fn() => ...)"}),"."]})]})}export{p as default};
