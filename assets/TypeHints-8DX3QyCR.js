...
10
2
0`}),e.jsx("p",{children:"Agora a versão tipada — e estrita:"}),e.jsx(r,{filename:"com-tipo.php",code:`<?php
...
NULL
NULL`}),e.jsx("h2",{children:'Union types (PHP 8.0+): "ou um, ou outro"'}),e.jsxs("p",{children:["Quando faz sentido aceitar mais de um tipo, separe com pipe (",e.jsx("code",{children:"|"}),"). É comum em funções de formatação que aceitam ",e.jsx("code",{children:"int|float"}),", ou em parsers que aceitam"," ",e.jsx("code",{children:"string|int"}),"."]}),e.jsx(r,{filename:"union.php",code:`<?php
declare(strict_types=1);
