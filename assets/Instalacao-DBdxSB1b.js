import{j as e}from"./index-B5-q-eol.js";import{P as n,A as i,a as r}from"./AlertBox-CVbFLZEd.js";import{T as o}from"./TerminalBlock-6fqVIX2R.js";import{C as s}from"./CodeBlock-B36pQ_ak.js";function c(){return e.jsxs(n,{title:"Instalando PHP",subtitle:"Como instalar PHP 8.4 em Linux (apt/dnf/pacman), macOS (brew) e Windows. Conferindo a instalação, ativando extensões essenciais e Docker como plano B universal.",difficulty:"iniciante",timeToRead:"12 min",category:"Instalação",children:[e.jsx(i,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Linux"})," "," — "," ","apt install php8.3-fpm + extensões (mbstring, xml, curl)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"macOS"})," "," — "," ","brew install php; ou Herd."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Windows"})," "," — "," ","XAMPP, Laragon ou php.exe + IIS."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Docker"})," "," — "," ","php:8.3-fpm-alpine + composer:2."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"php -v / php -m"})," "," — "," ","verifica versão e módulos."]})]}),e.jsxs("h2",{children:["O objetivo: ",e.jsx("code",{children:"php -v"})," imprimindo 8.4"]}),e.jsx("p",{children:"Você terminou este capítulo quando conseguir abrir um terminal e ver algo como:"}),e.jsx(o,{user:"dev",host:"php",cwd:"~",command:"php -v",output:`PHP 8.4.1 (cli) (built: Nov 19 2024 18:02:10) (NTS)
...
Additional .ini files parsed:      /etc/php/8.4/cli/conf.d/10-mysqlnd.ini,
                                   /etc/php/8.4/cli/conf.d/10-opcache.ini`}),e.jsx("p",{children:"Settings que você quase sempre vai querer ajustar para desenvolvimento:"}),e.jsx(s,{title:"/etc/php/8.4/cli/conf.d/99-dev.ini",language:"ini",code:`memory_limit = 512M
