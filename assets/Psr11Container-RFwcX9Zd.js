import{j as e}from"./index-B5-q-eol.js";import{P as n,A as o,a as r}from"./AlertBox-CVbFLZEd.js";import{T as a}from"./TerminalBlock-6fqVIX2R.js";import{C as i}from"./CodeBlock-B36pQ_ak.js";function l(){return e.jsxs(n,{title:"PSR-11 Container (DI)",subtitle:"O contrato universal para containers de injeção de dependências em PHP. Aprenda get/has, autowiring por reflection, services compartilhados vs factories e por que service locator é um anti-pattern.",difficulty:"avancado",timeToRead:"13 min",category:"PSR Standards",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"ContainerInterface"})," "," — "," ","PSR-11 — get/has para localizar serviços."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"DI"})," "," — "," ","Dependency Injection — recebe deps no construtor."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Autowiring"})," "," — "," ","container resolve deps olhando type hints."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Implementations"})," "," — "," ","PHP-DI, Symfony Container, Laravel Container, league/container."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Service vs factory"})," "," — "," ","service = mesma instância; factory = nova a cada get."]})]}),e.jsx("h2",{children:"O problema: instanciar coisas que dependem de coisas"}),e.jsxs("p",{children:["Imagine um ",e.jsx("code",{children:"UserController"})," que precisa de um ",e.jsx("code",{children:"UserRepository"}),", que precisa de um ",e.jsx("code",{children:"PDO"}),", que precisa de uma string de conexão. Se você instanciar tudo na mão em cada lugar, vai duplicar setup, esquecer de fechar conexões e travar a testabilidade. O ",e.jsx("strong",{children:"container de DI"})," resolve isso: você descreve como construir as coisas ",e.jsx("em",{children:"uma vez"})," e pede pronto quando precisar."]}),e.jsx(r,{filename:"sem-container.php",code:`<?php
...
}`}),e.jsxs("p",{children:["Container resolvido, dependências limpas. No próximo capítulo a gente conecta esse container com o ",e.jsx("strong",{children:"PSR-15 Middleware"})," para montar uma mini app HTTP do zero."]})]})}export{l as default};
