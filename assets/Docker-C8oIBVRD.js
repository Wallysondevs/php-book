...
EXPOSE 9000
CMD ["php-fpm"]`}),e.jsx(i,{filename:"docker/opcache.ini",language:"ini",code:`opcache.enable=1
...
CMD ["php-fpm"]`}),e.jsx(a,{type:"success",title:"Por que isso é melhor",children:e.jsxs("ul",{className:"list-disc ml-5 mt-1 space-y-1",children:[e.jsxs("li",{children:["O cache do Docker reaproveita a camada do vendor enquanto ",e.jsx("code",{children:"composer.lock"})," não muda — builds 10x mais rápidos."]}),e.jsxs("li",{children:["A imagem final não tem Composer, headers de dev (",e.jsx("code",{children:"-dev"})," dos pacotes apk), nem ferramentas de build. Menos superfície, menos CVE."]}),e.jsxs("li",{children:[e.jsx("code",{children:"USER www-data"})," evita rodar PHP como root dentro do container (regra básica de segurança)."]})]})}),e.jsx("h2",{children:"Healthcheck: deixe o orquestrador saber quando o container quebrou"}),e.jsxs("p",{children:["Sem healthcheck, o Docker considera “saudável” qualquer container cujo processo principal ainda está vivo — mesmo que o PHP-FPM esteja travado em deadlock. O bloco",e.jsx("code",{children:" HEALTHCHECK"})," testa se a porta 9000 aceita conexão a cada 30s."]}),e.jsx(i,{filename:"public/health.php",code:`<?php
...
{"status":"ok","php":"8.4.1","time":"2025-01-29T14:22:08+00:00"}`}),e.jsx("h2",{children:"docker-compose.yml: subindo o stack inteiro"}),e.jsxs("p",{children:["Em dev, você não quer rodar três ",e.jsx("code",{children:"docker run"})," separados. O Compose orquestra",e.jsx("strong",{children:" php-fpm + nginx + mysql"})," com volumes, rede privada e dependências entre serviços."]}),e.jsx(s,{title:"docker-compose.yml",language:"yaml",code:`services:
  app:
    build: .
    image: loja-php:dev
    volumes:
...
networks:
  loja:
    driver: bridge`}),e.jsx(s,{title:"docker/nginx.conf",language:"nginx",code:`server {
    listen 80;
    server_name _;
...
OK (27 tests, 51 assertions)`}),e.jsx("h2",{children:"Variáveis de ambiente: o jeito 12-Factor"}),e.jsx(i,{filename:"src/Config.php",code:`<?php
declare(strict_types=1);
