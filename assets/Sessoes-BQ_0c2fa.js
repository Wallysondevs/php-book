import{j as e}from"./index-B5-q-eol.js";import{P as r,A as o,a as s}from"./AlertBox-CVbFLZEd.js";import{T as i}from"./TerminalBlock-6fqVIX2R.js";import{B as a}from"./BrowserBlock-pEcgE37D.js";function l(){return e.jsxs(r,{title:"Sessões e Cookies",subtitle:"Como manter o usuário logado entre cliques: o ABC de session_start, $_SESSION, regenerate_id contra session fixation e cookies com httponly/secure/samesite.",difficulty:"intermediario",timeToRead:"13 min",category:"Web & Banco",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:e.jsx("p",{children:"Antes deste capítulo, é bom já ter visto os capítulos anteriores. Este texto se apoia no que já foi visto sobre PHP."})}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"session_start()"})," "," — "," ","inicia/recupera sessão; manda cookie PHPSESSID."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"$_SESSION"})," "," — "," ","array superglobal persistido entre requests."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Handler"})," "," — "," ","pode salvar em arquivo (default), Redis, Memcached, banco."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Lifetime"})," "," — "," ","session.gc_maxlifetime + cookie_lifetime no php.ini."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Hijack"})," "," — "," ","regenere ID após login: session_regenerate_id(true)."]})]}),e.jsx("h2",{children:"HTTP é stateless — e por isso a gente precisa de sessões"}),e.jsxs("p",{children:["Cada requisição HTTP é independente: o servidor não lembra que você acabou de logar no clique anterior. A solução é dar ao navegador um ",e.jsx("strong",{children:"cookie"})," com um identificador, e guardar no servidor o estado vinculado a esse identificador. Isso é uma ",e.jsx("strong",{children:"sessão"}),"."]}),e.jsx("h2",{children:"Iniciando uma sessão"}),e.jsxs("p",{children:["A função ",e.jsx("code",{children:"session_start"})," faz dois movimentos: lê o cookie"," ",e.jsx("code",{children:"PHPSESSID"})," do request (criando um se não existir) e popula"," ",e.jsx("code",{children:"$_SESSION"})," com os dados persistidos no servidor."]}),e.jsx(s,{filename:"public/contador.php",code:`<?php
...
</html>`}),e.jsxs(a,{url:"http://localhost:8000/contador.php",children:[e.jsx("h1",{className:"text-2xl font-bold",children:"Você abriu esta página 7 vez(es)"}),e.jsx("p",{className:"mt-2",children:"Atualize a página para ver o número subir."})]}),e.jsxs(o,{type:"warning",title:"session_start ANTES de qualquer saída",children:["Como ",e.jsx("code",{children:"session_start"})," envia o cookie da sessão (header HTTP), ele precisa ser chamado ",e.jsx("strong",{children:"antes"})," de qualquer ",e.jsx("code",{children:"echo"}),", espaço em branco ou",e.jsx("code",{children:"?>"})," que vire output. Se não, o clássico ",e.jsx("em",{children:'"headers already sent"'}),"."]}),e.jsxs("h2",{children:["Lendo, gravando e apagando do ",e.jsx("code",{children:"$_SESSION"})]}),e.jsxs("p",{children:["É um array PHP comum — você atribui chaves, lê, faz ",e.jsx("code",{children:"unset"}),":"]}),e.jsx(s,{filename:"public/carrinho.php",code:`<?php
declare(strict_types=1);
